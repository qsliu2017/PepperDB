...
pub struct ProcArray {
    ...
    vis: parking_lot::Mutex<GlobalVisStates>,
}
...
impl ProcArray {
    ...
    pub fn new(max_procs: usize) -> Self {
        ...
        Self {
            ...
            vis: parking_lot::Mutex::new(GlobalVisStates::new()),
        }
    }
}
...
impl ProcArray {
    ...
    pub fn proc_array_add(&self, pgprocno: ProcNumber) {
        ...
        if let Some(g) = crate::storage::proc::ProcGlobal::get() {
...
impl ProcArray {
    ...
    pub fn get_max_snapshot_xid_count(&self) -> i32 {
        self.inner.read().max_procs as i32
    }
}
...
impl ProcArray {
    ...
    pub fn get_max_snapshot_subxid_count(&self) -> i32 {
        let max_procs = self.inner.read().max_procs;
...
fn with_proc_globals<R>(a: &ProcArrayInner, f: impl FnOnce(&ProcGlobalView) -> R) -> R {
    let g = crate::storage::proc::ProcGlobal::get().map(std::convert::AsRef::as_ref);
    let n = a.pgprocnos.len();
...
mod tests {
    ...
    async fn snapshot_sees_then_loses_a_live_backend_xid() {
        ...
        let vc = crate::backend::access::transam::transam::VariableCache::expect().clone();
        ...
        crate::storage::proc::my_proc_scope(crate::session::scope(
            ...
            async {
                ...
                {
                    let g = crate::storage::proc::ProcGlobal::get().unwrap();
