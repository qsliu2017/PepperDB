...
pub const AggregateRelationId: Oid = Oid::new(2600);
...
pub const AggregateRelation_Rowtype_Id: Oid = Oid::new(11628);
...
pub const AggregateFnoidIndexId: Oid = Oid::new(2650);
