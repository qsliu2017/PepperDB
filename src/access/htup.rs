...
// Forward declarations for structs whose full (on-disk) definition lives in
// htup_details.h (level 5). Rule 7: translated locally as opaque placeholders
// and repointed in Phase 2.
#[deprecated(note = "TODO(struct-forward): repoint to crate::access::htup_details::HeapTupleHeaderData in Phase 2")]
#[repr(C)]
pub struct HeapTupleHeaderData {
    _private: [u8; 0],
}

#[deprecated(note = "TODO(struct-forward): repoint to crate::access::htup_details::MinimalTupleData in Phase 2")]
#[repr(C)]
