...
/* brin.c */
pub fn brin_build_desc(_rel: &RelationData) -> *mut BrinDesc {
    unimplemented!()
}
...
pub fn brinbuildempty(_index: &RelationData) {
    unimplemented!()
}
pub fn brininsert(
...
pub fn brininsertcleanup(_index: &RelationData, _index_info: &mut IndexInfo) {
    unimplemented!()
}
pub fn brinbeginscan(_r: &RelationData, _nkeys: i32, _norderbys: i32) -> IndexScanDesc {
    unimplemented!()
}
