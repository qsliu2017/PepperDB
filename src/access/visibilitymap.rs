...
pub fn VM_ALL_VISIBLE(r: Relation, b: BlockNumber, v: &mut Buffer) -> bool {
...
pub fn VM_ALL_FROZEN(r: Relation, b: BlockNumber, v: &mut Buffer) -> bool {
...
pub fn visibilitymap_pin(_rel: Relation, _heapBlk: BlockNumber, _vmbuf: &mut Buffer) {
    unimplemented!()
}
...
pub fn visibilitymap_count(_rel: Relation) -> (BlockNumber, BlockNumber) {
    unimplemented!()
}
pub fn visibilitymap_prepare_truncate(_rel: Relation, _nheapblocks: BlockNumber) -> BlockNumber {
    unimplemented!()
}
