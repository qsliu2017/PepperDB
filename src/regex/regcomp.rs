...
// regc_locale.c).  In the Rust port they are separate modules.
// ---------------------------------------------------------------------------

use crate::regex::regc_lex::{lexstart, newline, next};
use crate::regex::regc_color::{
    colorcomplement, freecm, initcm, okcolors, rainbow, subcolor, subcoloronechr, subcolorcvec,
};
use crate::regex::regc_nfa::{
    cloneouts, compact, copyouts, cparc, delsub, dropstate, dupnfa, freearc, freecnfa, freenfa,
    freestate, moveins, moveouts, newarc, newnfa, newstate, optimize, removeconstraints,
    single_color_transition, specialcolors,
};
use crate::regex::regc_cvec::{freecvec, newcvec};
use crate::regex::regc_locale::{
    allcases, casecmp, cclasscvec, cmp, eclass, element, lookupcclass, range,
};
use crate::regex::regc_pg_locale::pg_set_regex_collation;
