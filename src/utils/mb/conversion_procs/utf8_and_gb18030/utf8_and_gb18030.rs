...
// #include "fmgr.h"            -> crate::utils::fmgr (FunctionCallInfo, PG_GETARG_*, PG_RETURN_*)
// #include "mb/pg_wchar.h"     -> crate::mb::wchar (pg_enc, pg_mb_radix_tree)
// #include "../../Unicode/gb18030_to_utf8.map" -> GB18030_TO_UNICODE_TREE (radix map, stubbed)
// #include "../../Unicode/utf8_to_gb18030.map" -> GB18030_FROM_UNICODE_TREE (radix map, stubbed)
//
// PG_MODULE_MAGIC_EXT / PG_FUNCTION_INFO_V1: handled by the wiring step.
use crate::prelude::*;
use crate::utils::mb::conv::{LocalToUtf, UtfToLocal};
