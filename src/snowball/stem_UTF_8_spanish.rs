//! Spanish Snowball stemmer (UTF-8).
//!
//! 1:1 translation of the generated
//! `src/backend/snowball/libstemmer/stem_UTF_8_spanish.c` (Snowball 2.2.0),
//! merged with its header `stem_UTF_8_spanish.h`. The runtime helpers come from
...
static S_0_2: [symbol; 2] = [0xC3, 0xA9];
static S_0_3: [symbol; 2] = [0xC3, 0xAD];
static S_0_4: [symbol; 2] = [0xC3, 0xB3];
static S_0_5: [symbol; 2] = [0xC3, 0xBA];
...
static A_0: [among; 6] = [
    ...
    among { s_size: 2, s: S_0_3.as_ptr(), substring_i: 0, result: 3, function: None },
    among { s_size: 2, s: S_0_4.as_ptr(), substring_i: 0, result: 4, function: None },
    among { s_size: 2, s: S_0_5.as_ptr(), substring_i: 0, result: 5, function: None },
];
...
static S_2_3: [symbol; 5] = [0xC3, 0xA1, b'n', b'd', b'o'];
static S_2_4: [symbol; 6] = [b'i', 0xC3, 0xA9, b'n', b'd', b'o'];
static S_2_5: [symbol; 2] = [b'a', b'r'];
static S_2_6: [symbol; 2] = [b'e', b'r'];
static S_2_7: [symbol; 2] = [b'i', b'r'];
static S_2_8: [symbol; 3] = [0xC3, 0xA1, b'r'];
static S_2_9: [symbol; 3] = [0xC3, 0xA9, b'r'];
static S_2_10: [symbol; 3] = [0xC3, 0xAD, b'r'];
...
static A_2: [among; 11] = [
    ...
    among { s_size: 5, s: S_2_3.as_ptr(), substring_i: -1, result: 2, function: None },
    among { s_size: 6, s: S_2_4.as_ptr(), substring_i: -1, result: 1, function: None },
    ...
    among { s_size: 3, s: S_2_8.as_ptr(), substring_i: -1, result: 3, function: None },
    among { s_size: 3, s: S_2_9.as_ptr(), substring_i: -1, result: 4, function: None },
    among { s_size: 3, s: S_2_10.as_ptr(), substring_i: -1, result: 5, function: None },
];
...
static S_6_8: [symbol; 6] = [b'l', b'o', b'g', 0xC3, 0xAD, b'a'];
...
static S_6_15: [symbol; 6] = [b'a', b'c', b'i', 0xC3, 0xB3, b'n'];
static S_6_16: [symbol; 6] = [b'u', b'c', b'i', 0xC3, 0xB3, b'n'];
...
static S_6_32: [symbol; 7] = [b'l', b'o', b'g', 0xC3, 0xAD, b'a', b's'];
...
static A_6: [among; 46] = [
    ...
    among { s_size: 6, s: S_6_8.as_ptr(), substring_i: -1, result: 3, function: None },
    ...
    among { s_size: 6, s: S_6_15.as_ptr(), substring_i: -1, result: 2, function: None },
    among { s_size: 6, s: S_6_16.as_ptr(), substring_i: -1, result: 4, function: None },
    ...
    among { s_size: 7, s: S_6_32.as_ptr(), substring_i: -1, result: 3, function: None },
...
static S_7_11: [symbol; 3] = [b'y', 0xC3, 0xB3];
...
static A_7: [among; 12] = [
    ...
    among { s_size: 3, s: S_7_11.as_ptr(), substring_i: -1, result: 1, function: None },
];
...
static S_8_5: [symbol; 3] = [0xC3, 0xAD, b'a'];
static S_8_6: [symbol; 5] = [b'a', b'r', 0xC3, 0xAD, b'a'];
static S_8_7: [symbol; 5] = [b'e', b'r', 0xC3, 0xAD, b'a'];
static S_8_8: [symbol; 5] = [b'i', b'r', 0xC3, 0xAD, b'a'];
...
static S_8_20: [symbol; 4] = [0xC3, 0xAD, b'a', b'n'];
static S_8_21: [symbol; 6] = [b'a', b'r', 0xC3, 0xAD, b'a', b'n'];
static S_8_22: [symbol; 6] = [b'e', b'r', 0xC3, 0xAD, b'a', b'n'];
static S_8_23: [symbol; 6] = [b'i', b'r', 0xC3, 0xAD, b'a', b'n'];
...
static S_8_29: [symbol; 5] = [b'a', b'r', 0xC3, 0xA1, b'n'];
static S_8_30: [symbol; 5] = [b'e', b'r', 0xC3, 0xA1, b'n'];
static S_8_31: [symbol; 5] = [b'i', b'r', 0xC3, 0xA1, b'n'];
...
static S_8_45: [symbol; 4] = [0xC3, 0xAD, b'a', b's'];
static S_8_46: [symbol; 6] = [b'a', b'r', 0xC3, 0xAD, b'a', b's'];
static S_8_47: [symbol; 6] = [b'e', b'r', 0xC3, 0xAD, b'a', b's'];
static S_8_48: [symbol; 6] = [b'i', b'r', 0xC3, 0xAD, b'a', b's'];
...
static S_8_55: [symbol; 5] = [0xC3, 0xAD, b'a', b'i', b's'];
static S_8_56: [symbol; 7] = [b'a', b'r', 0xC3, 0xAD, b'a', b'i', b's'];
static S_8_57: [symbol; 7] = [b'e', b'r', 0xC3, 0xAD, b'a', b'i', b's'];
static S_8_58: [symbol; 7] = [b'i', b'r', 0xC3, 0xAD, b'a', b'i', b's'];
...
static S_8_63: [symbol; 4] = [0xC3, 0xA1, b'i', b's'];
static S_8_64: [symbol; 4] = [0xC3, 0xA9, b'i', b's'];
static S_8_65: [symbol; 6] = [b'a', b'r', 0xC3, 0xA9, b'i', b's'];
static S_8_66: [symbol; 6] = [b'e', b'r', 0xC3, 0xA9, b'i', b's'];
static S_8_67: [symbol; 6] = [b'i', b'r', 0xC3, 0xA9, b'i', b's'];
static S_8_68: [symbol; 4] = [b'a', b'd', b'o', b's'];
static S_8_69: [symbol; 4] = [b'i', b'd', b'o', b's'];
static S_8_70: [symbol; 4] = [b'a', b'm', b'o', b's'];
static S_8_71: [symbol; 7] = [0xC3, 0xA1, b'b', b'a', b'm', b'o', b's'];
static S_8_72: [symbol; 7] = [0xC3, 0xA1, b'r', b'a', b'm', b'o', b's'];
static S_8_73: [symbol; 8] = [b'i', 0xC3, 0xA9, b'r', b'a', b'm', b'o', b's'];
static S_8_74: [symbol; 6] = [0xC3, 0xAD, b'a', b'm', b'o', b's'];
static S_8_75: [symbol; 8] = [b'a', b'r', 0xC3, 0xAD, b'a', b'm', b'o', b's'];
static S_8_76: [symbol; 8] = [b'e', b'r', 0xC3, 0xAD, b'a', b'm', b'o', b's'];
static S_8_77: [symbol; 8] = [b'i', b'r', 0xC3, 0xAD, b'a', b'm', b'o', b's'];
...
static S_8_82: [symbol; 7] = [0xC3, 0xA1, b's', b'e', b'm', b'o', b's'];
static S_8_83: [symbol; 8] = [b'i', 0xC3, 0xA9, b's', b'e', b'm', b'o', b's'];
static S_8_84: [symbol; 4] = [b'i', b'm', b'o', b's'];
static S_8_85: [symbol; 5] = [b'a', b'r', 0xC3, 0xA1, b's'];
static S_8_86: [symbol; 5] = [b'e', b'r', 0xC3, 0xA1, b's'];
static S_8_87: [symbol; 5] = [b'i', b'r', 0xC3, 0xA1, b's'];
static S_8_88: [symbol; 3] = [0xC3, 0xAD, b's'];
static S_8_89: [symbol; 4] = [b'a', b'r', 0xC3, 0xA1];
static S_8_90: [symbol; 4] = [b'e', b'r', 0xC3, 0xA1];
static S_8_91: [symbol; 4] = [b'i', b'r', 0xC3, 0xA1];
static S_8_92: [symbol; 4] = [b'a', b'r', 0xC3, 0xA9];
static S_8_93: [symbol; 4] = [b'e', b'r', 0xC3, 0xA9];
static S_8_94: [symbol; 4] = [b'i', b'r', 0xC3, 0xA9];
static S_8_95: [symbol; 3] = [b'i', 0xC3, 0xB3];
...
static A_8: [among; 96] = [
    ...
    among { s_size: 3, s: S_8_5.as_ptr(), substring_i: -1, result: 2, function: None },
    among { s_size: 5, s: S_8_6.as_ptr(), substring_i: 5, result: 2, function: None },
    among { s_size: 5, s: S_8_7.as_ptr(), substring_i: 5, result: 2, function: None },
    among { s_size: 5, s: S_8_8.as_ptr(), substring_i: 5, result: 2, function: None },
    ...
    among { s_size: 4, s: S_8_20.as_ptr(), substring_i: 16, result: 2, function: None },
    among { s_size: 6, s: S_8_21.as_ptr(), substring_i: 20, result: 2, function: None },
    among { s_size: 6, s: S_8_22.as_ptr(), substring_i: 20, result: 2, function: None },
    among { s_size: 6, s: S_8_23.as_ptr(), substring_i: 20, result: 2, function: None },
    ...
    among { s_size: 5, s: S_8_29.as_ptr(), substring_i: -1, result: 2, function: None },
    among { s_size: 5, s: S_8_30.as_ptr(), substring_i: -1, result: 2, function: None },
    among { s_size: 5, s: S_8_31.as_ptr(), substring_i: -1, result: 2, function: None },
    ...
    among { s_size: 4, s: S_8_45.as_ptr(), substring_i: 39, result: 2, function: None },
    among { s_size: 6, s: S_8_46.as_ptr(), substring_i: 45, result: 2, function: None },
    among { s_size: 6, s: S_8_47.as_ptr(), substring_i: 45, result: 2, function: None },
    among { s_size: 6, s: S_8_48.as_ptr(), substring_i: 45, result: 2, function: None },
    ...
    among { s_size: 5, s: S_8_55.as_ptr(), substring_i: -1, result: 2, function: None },
    among { s_size: 7, s: S_8_56.as_ptr(), substring_i: 55, result: 2, function: None },
    among { s_size: 7, s: S_8_57.as_ptr(), substring_i: 55, result: 2, function: None },
    among { s_size: 7, s: S_8_58.as_ptr(), substring_i: 55, result: 2, function: None },
    ...
    among { s_size: 4, s: S_8_63.as_ptr(), substring_i: -1, result: 2, function: None },
    among { s_size: 4, s: S_8_64.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 6, s: S_8_65.as_ptr(), substring_i: 64, result: 2, function: None },
    among { s_size: 6, s: S_8_66.as_ptr(), substring_i: 64, result: 2, function: None },
    among { s_size: 6, s: S_8_67.as_ptr(), substring_i: 64, result: 2, function: None },
    ...
    among { s_size: 7, s: S_8_71.as_ptr(), substring_i: 70, result: 2, function: None },
    among { s_size: 7, s: S_8_72.as_ptr(), substring_i: 70, result: 2, function: None },
    among { s_size: 8, s: S_8_73.as_ptr(), substring_i: 70, result: 2, function: None },
    among { s_size: 6, s: S_8_74.as_ptr(), substring_i: 70, result: 2, function: None },
    among { s_size: 8, s: S_8_75.as_ptr(), substring_i: 74, result: 2, function: None },
    among { s_size: 8, s: S_8_76.as_ptr(), substring_i: 74, result: 2, function: None },
    among { s_size: 8, s: S_8_77.as_ptr(), substring_i: 74, result: 2, function: None },
    ...
    among { s_size: 7, s: S_8_82.as_ptr(), substring_i: 78, result: 2, function: None },
    among { s_size: 8, s: S_8_83.as_ptr(), substring_i: 78, result: 2, function: None },
    among { s_size: 4, s: S_8_84.as_ptr(), substring_i: -1, result: 2, function: None },
    among { s_size: 5, s: S_8_85.as_ptr(), substring_i: -1, result: 2, function: None },
    among { s_size: 5, s: S_8_86.as_ptr(), substring_i: -1, result: 2, function: None },
    among { s_size: 5, s: S_8_87.as_ptr(), substring_i: -1, result: 2, function: None },
    among { s_size: 3, s: S_8_88.as_ptr(), substring_i: -1, result: 2, function: None },
    among { s_size: 4, s: S_8_89.as_ptr(), substring_i: -1, result: 2, function: None },
    among { s_size: 4, s: S_8_90.as_ptr(), substring_i: -1, result: 2, function: None },
    among { s_size: 4, s: S_8_91.as_ptr(), substring_i: -1, result: 2, function: None },
    among { s_size: 4, s: S_8_92.as_ptr(), substring_i: -1, result: 2, function: None },
    among { s_size: 4, s: S_8_93.as_ptr(), substring_i: -1, result: 2, function: None },
    among { s_size: 4, s: S_8_94.as_ptr(), substring_i: -1, result: 2, function: None },
    among { s_size: 3, s: S_8_95.as_ptr(), substring_i: -1, result: 2, function: None },
];
...
static S_9_4: [symbol; 2] = [0xC3, 0xA1];
static S_9_5: [symbol; 2] = [0xC3, 0xA9];
static S_9_6: [symbol; 2] = [0xC3, 0xAD];
static S_9_7: [symbol; 2] = [0xC3, 0xB3];
...
static A_9: [among; 8] = [
    ...
    among { s_size: 2, s: S_9_4.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 2, s: S_9_5.as_ptr(), substring_i: -1, result: 2, function: None },
    among { s_size: 2, s: S_9_6.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 2, s: S_9_7.as_ptr(), substring_i: -1, result: 1, function: None },
];
    ...
    *(*z).I.offset(0) = (*z).l;
    {
        ...
        'lab0: {
            'lab1: {
                let c2 = (*z).c;
                'lab2: {
                    if in_grouping_U(z, G_V.as_ptr(), 97, 252, 0) != 0 {
                        break 'lab2;
                    }
                    'lab3: {
                        let c3 = (*z).c;
                        'lab4: {
                            if out_grouping_U(z, G_V.as_ptr(), 97, 252, 0) != 0 {
                                break 'lab4;
                            }
                            {
    ...
    'zspa12: loop {
        ...
        'lab0: {
            ...
            if (*z).c + 1 >= (*z).l
                ...
                || (67641858 >> (*(*z).p.offset(((*z).c + 1) as isize) as c_int & 0x1f)) & 1 == 0
            {
                among_var = 6;
            } else {
...
unsafe fn r_attached_pronoun(z: *mut SN_env) -> c_int {
    ...
    (*z).bra = (*z).c;
    if (*z).c - 1 <= (*z).lb
        || (*(*z).p.offset(((*z).c - 1) as isize) != 111 && *(*z).p.offset(((*z).c - 1) as isize) != 114)
    {
        return 0;
    }
        ...
        6 => {
            ...
            }
            {
                ...
                'lab1: {
                    ...
                    if (*z).c - 1 <= (*z).lb
                        || *(*z).p.offset(((*z).c - 1) as isize) as c_int >> 5 != 3
                        || (4718616 >> (*(*z).p.offset(((*z).c - 1) as isize) as c_int & 0x1f)) & 1 == 0
                    {
                        (*z).c = (*z).l - m2;
                        break 'lab1;
                    }
        ...
        8 => {
            ...
            }
            {
                ...
                'lab3: {
                    ...
                    if (*z).c - 1 <= (*z).lb
                        || *(*z).p.offset(((*z).c - 1) as isize) as c_int >> 5 != 3
                        || (4198408 >> (*(*z).p.offset(((*z).c - 1) as isize) as c_int & 0x1f)) & 1 == 0
                    {
                        (*z).c = (*z).l - m4;
                        break 'lab3;
                    }
...
#[no_mangle]
pub unsafe extern "C" fn spanish_UTF_8_stem(z: *mut SN_env) -> c_int {
    {
...
#[no_mangle]
pub unsafe extern "C" fn spanish_UTF_8_create_env() -> *mut SN_env {
    SN_create_env(0, 3)
}

#[no_mangle]
pub unsafe extern "C" fn spanish_UTF_8_close_env(z: *mut SN_env) {
    SN_close_env(z, 0)
}
...
mod tests {
    ...
    fn idempotent() {
        unsafe {
            for w in [&b"perro"[..], &b"caminando"[..], &b"nacionalismo"[..]] {
                let once = stem(w);
                let twice = stem(&once);
