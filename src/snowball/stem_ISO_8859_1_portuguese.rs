//! Portuguese Snowball stemmer (ISO-8859-1, single-byte).
//!
//! 1:1 translation of the generated
//! `src/backend/snowball/libstemmer/stem_ISO_8859_1_portuguese.c` (Snowball
...
//! as 0xE3 ('a' with tilde) and 0xE7 ('c' cedilla) are stored and compared as raw
//! bytes. The internal nasal markers 'a~' / 'o~' use the literal '~' (0x7E).
...
static S_0_1: [symbol; 1] = [0xE3];
static S_0_2: [symbol; 1] = [0xF5];
...
static S_3_2: [symbol; 4] = [0xED, b'v', b'e', b'l'];
...
static S_5_1: [symbol; 5] = [0xE2, b'n', b'c', b'i', b'a'];
static S_5_2: [symbol; 5] = [0xEA, b'n', b'c', b'i', b'a'];
...
static S_5_14: [symbol; 4] = [0xE1, b'v', b'e', b'l'];
static S_5_15: [symbol; 4] = [0xED, b'v', b'e', b'l'];
...
static S_5_22: [symbol; 5] = [b'a', 0xE7, b'a', b'~', b'o'];
static S_5_23: [symbol; 5] = [b'u', 0xE7, b'a', b'~', b'o'];
static S_5_24: [symbol; 4] = [b'a', b'd', b'o', b'r'];
static S_5_25: [symbol; 4] = [b'i', b'c', b'a', b's'];
static S_5_26: [symbol; 6] = [0xEA, b'n', b'c', b'i', b'a', b's'];
...
static S_5_37: [symbol; 6] = [b'a', 0xE7, b'o', b'~', b'e', b's'];
static S_5_38: [symbol; 6] = [b'u', 0xE7, b'o', b'~', b'e', b's'];
...
static A_5: [among; 45] = [
    ...
    among { s_size: 5, s: S_5_1.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 5, s: S_5_2.as_ptr(), substring_i: -1, result: 4, function: None },
    ...
    among { s_size: 4, s: S_5_15.as_ptr(), substring_i: -1, result: 1, function: None },
    ...
    among { s_size: 5, s: S_5_22.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 5, s: S_5_23.as_ptr(), substring_i: -1, result: 3, function: None },
    ...
    among { s_size: 6, s: S_5_26.as_ptr(), substring_i: -1, result: 4, function: None },
    ...
    among { s_size: 6, s: S_5_37.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 6, s: S_5_38.as_ptr(), substring_i: -1, result: 3, function: None },
...
static S_6_77: [symbol; 5] = [0xE1, b'r', b'e', b'i', b's'];
static S_6_78: [symbol; 5] = [0xE9, b'r', b'e', b'i', b's'];
static S_6_79: [symbol; 5] = [0xED, b'r', b'e', b'i', b's'];
static S_6_80: [symbol; 6] = [0xE1, b's', b's', b'e', b'i', b's'];
static S_6_81: [symbol; 6] = [0xE9, b's', b's', b'e', b'i', b's'];
static S_6_82: [symbol; 6] = [0xED, b's', b's', b'e', b'i', b's'];
static S_6_83: [symbol; 5] = [0xE1, b'v', b'e', b'i', b's'];
static S_6_84: [symbol; 4] = [0xED, b'e', b'i', b's'];
static S_6_85: [symbol; 6] = [b'a', b'r', 0xED, b'e', b'i', b's'];
static S_6_86: [symbol; 6] = [b'e', b'r', 0xED, b'e', b'i', b's'];
static S_6_87: [symbol; 6] = [b'i', b'r', 0xED, b'e', b'i', b's'];
static S_6_88: [symbol; 4] = [b'a', b'd', b'o', b's'];
static S_6_89: [symbol; 4] = [b'i', b'd', b'o', b's'];
static S_6_90: [symbol; 4] = [b'a', b'm', b'o', b's'];
static S_6_91: [symbol; 6] = [0xE1, b'r', b'a', b'm', b'o', b's'];
static S_6_92: [symbol; 6] = [0xE9, b'r', b'a', b'm', b'o', b's'];
static S_6_93: [symbol; 6] = [0xED, b'r', b'a', b'm', b'o', b's'];
static S_6_94: [symbol; 6] = [0xE1, b'v', b'a', b'm', b'o', b's'];
static S_6_95: [symbol; 5] = [0xED, b'a', b'm', b'o', b's'];
static S_6_96: [symbol; 7] = [b'a', b'r', 0xED, b'a', b'm', b'o', b's'];
static S_6_97: [symbol; 7] = [b'e', b'r', 0xED, b'a', b'm', b'o', b's'];
static S_6_98: [symbol; 7] = [b'i', b'r', 0xED, b'a', b'm', b'o', b's'];
...
static S_6_103: [symbol; 7] = [0xE1, b's', b's', b'e', b'm', b'o', b's'];
static S_6_104: [symbol; 7] = [0xEA, b's', b's', b'e', b'm', b'o', b's'];
static S_6_105: [symbol; 7] = [0xED, b's', b's', b'e', b'm', b'o', b's'];
...
static S_6_110: [symbol; 4] = [0xE1, b'm', b'o', b's'];
static S_6_111: [symbol; 4] = [b'a', b'r', 0xE1, b's'];
static S_6_112: [symbol; 4] = [b'e', b'r', 0xE1, b's'];
static S_6_113: [symbol; 4] = [b'i', b'r', 0xE1, b's'];
static S_6_114: [symbol; 2] = [b'e', b'u'];
static S_6_115: [symbol; 2] = [b'i', b'u'];
static S_6_116: [symbol; 2] = [b'o', b'u'];
static S_6_117: [symbol; 3] = [b'a', b'r', 0xE1];
static S_6_118: [symbol; 3] = [b'e', b'r', 0xE1];
static S_6_119: [symbol; 3] = [b'i', b'r', 0xE1];
...
static A_6: [among; 120] = [
    ...
    among { s_size: 5, s: S_6_77.as_ptr(), substring_i: 73, result: 1, function: None },
    among { s_size: 5, s: S_6_78.as_ptr(), substring_i: 73, result: 1, function: None },
    among { s_size: 5, s: S_6_79.as_ptr(), substring_i: 73, result: 1, function: None },
    among { s_size: 6, s: S_6_80.as_ptr(), substring_i: 73, result: 1, function: None },
    among { s_size: 6, s: S_6_81.as_ptr(), substring_i: 73, result: 1, function: None },
    among { s_size: 6, s: S_6_82.as_ptr(), substring_i: 73, result: 1, function: None },
    among { s_size: 5, s: S_6_83.as_ptr(), substring_i: 73, result: 1, function: None },
    among { s_size: 4, s: S_6_84.as_ptr(), substring_i: 73, result: 1, function: None },
    among { s_size: 6, s: S_6_85.as_ptr(), substring_i: 84, result: 1, function: None },
    among { s_size: 6, s: S_6_86.as_ptr(), substring_i: 84, result: 1, function: None },
    among { s_size: 6, s: S_6_87.as_ptr(), substring_i: 84, result: 1, function: None },
    ...
    among { s_size: 6, s: S_6_91.as_ptr(), substring_i: 90, result: 1, function: None },
    among { s_size: 6, s: S_6_92.as_ptr(), substring_i: 90, result: 1, function: None },
    among { s_size: 6, s: S_6_93.as_ptr(), substring_i: 90, result: 1, function: None },
    among { s_size: 6, s: S_6_94.as_ptr(), substring_i: 90, result: 1, function: None },
    among { s_size: 5, s: S_6_95.as_ptr(), substring_i: 90, result: 1, function: None },
    among { s_size: 7, s: S_6_96.as_ptr(), substring_i: 95, result: 1, function: None },
    among { s_size: 7, s: S_6_97.as_ptr(), substring_i: 95, result: 1, function: None },
    among { s_size: 7, s: S_6_98.as_ptr(), substring_i: 95, result: 1, function: None },
    ...
    among { s_size: 7, s: S_6_103.as_ptr(), substring_i: 99, result: 1, function: None },
    among { s_size: 7, s: S_6_104.as_ptr(), substring_i: 99, result: 1, function: None },
    among { s_size: 7, s: S_6_105.as_ptr(), substring_i: 99, result: 1, function: None },
    ...
    among { s_size: 4, s: S_6_110.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 4, s: S_6_111.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 4, s: S_6_112.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 4, s: S_6_113.as_ptr(), substring_i: -1, result: 1, function: None },
    ...
    among { s_size: 3, s: S_6_117.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 3, s: S_6_118.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 3, s: S_6_119.as_ptr(), substring_i: -1, result: 1, function: None },
];
...
static S_7_4: [symbol; 1] = [0xE1];
static S_7_5: [symbol; 1] = [0xED];
static S_7_6: [symbol; 1] = [0xF3];
...
static A_7: [among; 7] = [
    ...
    among { s_size: 1, s: S_7_4.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 1, s: S_7_5.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 1, s: S_7_6.as_ptr(), substring_i: -1, result: 1, function: None },
];

static S_8_0: [symbol; 1] = [b'e'];
static S_8_1: [symbol; 1] = [0xE7];
static S_8_2: [symbol; 1] = [0xE9];
static S_8_3: [symbol; 1] = [0xEA];
...
static A_8: [among; 4] = [
    ...
    among { s_size: 1, s: S_8_2.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 1, s: S_8_3.as_ptr(), substring_i: -1, result: 1, function: None },
];
...
static S_2: [symbol; 1] = [0xE3];
static S_3: [symbol; 1] = [0xF5];
...
unsafe fn r_prelude(z: *mut SN_env) -> c_int {
    ...
    'loop0: loop {
        ...
        'lab0: {
            (*z).bra = (*z).c;
            if (*z).c >= (*z).l
                || (*(*z).p.offset((*z).c as isize) != 227
                    && *(*z).p.offset((*z).c as isize) != 245)
            {
                among_var = 3;
            } else {
    ...
    *(*z).I.offset(0) = (*z).l;
    {
        ...
        'lab0: {
            'lab1: {
                let c2 = (*z).c;
                'lab2: {
                    if in_grouping(z, G_V.as_ptr(), 97, 250, 0) != 0 {
                        break 'lab2;
                    }
                    {
                        let c3 = (*z).c;
                        'lab3: {
                            'lab4: {
                                if out_grouping(z, G_V.as_ptr(), 97, 250, 0) != 0 {
                                    break 'lab4;
                                }
                                {
...
#[no_mangle]
pub unsafe extern "C" fn portuguese_ISO_8859_1_stem(z: *mut SN_env) -> c_int {
    {
        let c1 = (*z).c;
        {
            let ret = r_prelude(z);
...
#[no_mangle]
pub unsafe extern "C" fn portuguese_ISO_8859_1_create_env() -> *mut SN_env {
    SN_create_env(0, 3)
}

#[no_mangle]
pub unsafe extern "C" fn portuguese_ISO_8859_1_close_env(z: *mut SN_env) {
    SN_close_env(z, 0)
}
...
mod tests {
    ...
    // ISO-8859-1 (single-byte), e.g. 0xE7 for 'c' cedilla, 0xE3 for 'a' tilde.
    #[test]
    fn idempotent() {
        unsafe {
            for w in [
    ...
    fn suffix_stripped_nonempty() {
        unsafe {
            let r = stem(b"nacionais");
            assert!(!r.is_empty());
            assert!(r.len() <= "nacionais".len());
        }
    }
}
