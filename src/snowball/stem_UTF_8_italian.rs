//! Italian Snowball stemmer (UTF-8).
//!
//! 1:1 translation of the generated
//! `src/backend/snowball/libstemmer/stem_UTF_8_italian.c` (Snowball 2.2.0),
//! merged with its header `stem_UTF_8_italian.h`. The runtime helpers come from
...
use crate::snowball::utilities::{
    eq_s, eq_s_b, find_among, find_among_b, in_grouping_b_U, in_grouping_U, out_grouping_U,
...
static S_0_2: [symbol; 2] = [0xC3, 0xA1];
static S_0_3: [symbol; 2] = [0xC3, 0xA9];
static S_0_4: [symbol; 2] = [0xC3, 0xAD];
static S_0_5: [symbol; 2] = [0xC3, 0xB3];
static S_0_6: [symbol; 2] = [0xC3, 0xBA];

static A_0: [among; 7] = [
    among { s_size: 0, s: std::ptr::null(), substring_i: -1, result: 7, function: None },
    ...
    among { s_size: 2, s: S_0_4.as_ptr(), substring_i: 0, result: 3, function: None },
    among { s_size: 2, s: S_0_5.as_ptr(), substring_i: 0, result: 4, function: None },
    among { s_size: 2, s: S_0_6.as_ptr(), substring_i: 0, result: 5, function: None },
];
...
static S_6_47: [symbol; 4] = [b'i', b't', 0xC3, 0xA0];
static S_6_48: [symbol; 5] = [b'i', b's', b't', 0xC3, 0xA0];
static S_6_49: [symbol; 5] = [b'i', b's', b't', 0xC3, 0xA8];
static S_6_50: [symbol; 5] = [b'i', b's', b't', 0xC3, 0xAC];
...
static A_6: [among; 51] = [
    ...
    among { s_size: 4, s: S_6_47.as_ptr(), substring_i: -1, result: 8, function: None },
    among { s_size: 5, s: S_6_48.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 5, s: S_6_49.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 5, s: S_6_50.as_ptr(), substring_i: -1, result: 1, function: None },
];
...
static S_7_83: [symbol; 4] = [b'e', b'r', 0xC3, 0xA0];
static S_7_84: [symbol; 4] = [b'i', b'r', 0xC3, 0xA0];
static S_7_85: [symbol; 4] = [b'e', b'r', 0xC3, 0xB2];
static S_7_86: [symbol; 4] = [b'i', b'r', 0xC3, 0xB2];
...
static A_7: [among; 87] = [
    ...
    among { s_size: 5, s: S_7_47.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 5, s: S_7_48.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 5, s: S_7_49.as_ptr(), substring_i: -1, result: 1, function: None },
    ...
    among { s_size: 4, s: S_7_83.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 4, s: S_7_84.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 4, s: S_7_85.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 4, s: S_7_86.as_ptr(), substring_i: -1, result: 1, function: None },
];
...
static S_0: [symbol; 2] = [0xC3, 0xA0];
static S_1: [symbol; 2] = [0xC3, 0xA8];
static S_2: [symbol; 2] = [0xC3, 0xAC];
static S_3: [symbol; 2] = [0xC3, 0xB2];
static S_4: [symbol; 2] = [0xC3, 0xB9];
    ...
    'repeat1: loop {
        ...
        'lab1: {
            'inner: loop {
                ...
                'lab2: {
                    'lab3: {
                        if in_grouping_U(z, G_V.as_ptr(), 97, 249, 0) != 0 {
                            break 'lab2;
                        }
                        (*z).bra = (*z).c;
                        {
            ...
            'lab1: {
                ...
                'lab2: {
                    ...
                    'lab3: {
                        let c3 = (*z).c;
                        'lab4: {
                            if out_grouping_U(z, G_V.as_ptr(), 97, 249, 0) != 0 {
                                break 'lab4;
                            }
                            {
                                let ret = out_grouping_U(z, G_V.as_ptr(), 97, 249, 1);
                                if ret < 0 {
                                    break 'lab4;
                                }
                                (*z).c += ret;
                        ...
                        {
                            let ret = in_grouping_U(z, G_V.as_ptr(), 97, 249, 1);
                            if ret < 0 {
                                break 'lab2;
                            }
                            (*z).c += ret;
...
unsafe fn r_vowel_suffix(z: *mut SN_env) -> c_int {
    {
        ...
        'lab0: {
            (*z).ket = (*z).c;
            if in_grouping_b_U(z, G_AEIO.as_ptr(), 97, 242, 0) != 0 {
                (*z).c = (*z).l - m1;
                break 'lab0;
            }
            (*z).bra = (*z).c;
    ...
    }
    {
        ...
        'lab1: {
            ...
            (*z).c -= 1;
            (*z).bra = (*z).c;
            if in_grouping_b_U(z, G_CG.as_ptr(), 99, 103, 0) != 0 {
                (*z).c = (*z).l - m2;
                break 'lab1;
            }
            {
...
#[no_mangle]
pub unsafe extern "C" fn italian_UTF_8_stem(z: *mut SN_env) -> c_int {
    'lab0: {
        let c1 = (*z).c;
        'lab1: {
            {
...
#[no_mangle]
pub unsafe extern "C" fn italian_UTF_8_create_env() -> *mut SN_env {
    SN_create_env(0, 3)
}

#[no_mangle]
pub unsafe extern "C" fn italian_UTF_8_close_env(z: *mut SN_env) {
    SN_close_env(z, 0)
}
...
mod tests {
    ...
    fn short_root_unchanged() {
        unsafe {
            assert_eq!(stem(b"casa"), stem(b"casa"));
            assert!(!stem(b"casa").is_empty());
        }
    }
