//! Snowball Hungarian (ISO_8859_2) stemmer.
//!
//! 1:1 translation of the generated
//! `src/backend/snowball/libstemmer/stem_ISO_8859_2_hungarian.c` (Snowball 2.2.0),
//! merged with its declarations header
//! `src/include/snowball/libstemmer/stem_ISO_8859_2_hungarian.h`.
//!
//! ISO_8859_2 is a SINGLE-BYTE encoding: this uses the non-`_U` grouping
//! helpers and plain single-byte advance (`z->c--`) instead of the UTF-8
//! `skip_*_utf8` helpers. The high accented characters (0xE1, 0xE9, 0xF3,
//! 0xF5, 0xF6, 0xFC, ...) are single raw bytes rather than multibyte UTF-8
//! sequences.
//!
...
static S_1_0: [symbol; 1] = [0xE1];
static S_1_1: [symbol; 1] = [0xE9];

static A_1: [among; 2] = [
    among { s_size: 1, s: S_1_0.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 1, s: S_1_1.as_ptr(), substring_i: -1, result: 2, function: None },
];
...
static S_4_10: [symbol; 3] = [b'n', 0xE1, b'l'];
static S_4_11: [symbol; 3] = [b'n', 0xE9, b'l'];
static S_4_12: [symbol; 3] = [b'b', 0xF3, b'l'];
static S_4_13: [symbol; 3] = [b'r', 0xF3, b'l'];
static S_4_14: [symbol; 3] = [b't', 0xF3, b'l'];
static S_4_15: [symbol; 3] = [b'b', 0xF5, b'l'];
static S_4_16: [symbol; 3] = [b'r', 0xF5, b'l'];
static S_4_17: [symbol; 3] = [b't', 0xF5, b'l'];
static S_4_18: [symbol; 2] = [0xFC, b'l'];
...
static S_4_24: [symbol; 6] = [b'k', 0xE9, b'p', b'p', b'e', b'n'];
static S_4_25: [symbol; 2] = [b'o', b'n'];
static S_4_26: [symbol; 2] = [0xF6, b'n'];
static S_4_27: [symbol; 4] = [b'k', 0xE9, b'p', b'p'];
static S_4_28: [symbol; 3] = [b'k', b'o', b'r'];
static S_4_29: [symbol; 1] = [b't'];
static S_4_30: [symbol; 2] = [b'a', b't'];
static S_4_31: [symbol; 2] = [b'e', b't'];
static S_4_32: [symbol; 4] = [b'k', 0xE9, b'n', b't'];
static S_4_33: [symbol; 6] = [b'a', b'n', b'k', 0xE9, b'n', b't'];
static S_4_34: [symbol; 6] = [b'e', b'n', b'k', 0xE9, b'n', b't'];
static S_4_35: [symbol; 6] = [b'o', b'n', b'k', 0xE9, b'n', b't'];
static S_4_36: [symbol; 2] = [b'o', b't'];
static S_4_37: [symbol; 3] = [0xE9, b'r', b't'];
static S_4_38: [symbol; 2] = [0xF6, b't'];
static S_4_39: [symbol; 3] = [b'h', b'e', b'z'];
static S_4_40: [symbol; 3] = [b'h', b'o', b'z'];
static S_4_41: [symbol; 3] = [b'h', 0xF6, b'z'];
static S_4_42: [symbol; 2] = [b'v', 0xE1];
static S_4_43: [symbol; 2] = [b'v', 0xE9];
...
static A_4: [among; 44] = [
    ...
    among { s_size: 3, s: S_4_10.as_ptr(), substring_i: -1, result: -1, function: None },
    among { s_size: 3, s: S_4_11.as_ptr(), substring_i: -1, result: -1, function: None },
    among { s_size: 3, s: S_4_12.as_ptr(), substring_i: -1, result: -1, function: None },
    among { s_size: 3, s: S_4_13.as_ptr(), substring_i: -1, result: -1, function: None },
    among { s_size: 3, s: S_4_14.as_ptr(), substring_i: -1, result: -1, function: None },
    among { s_size: 3, s: S_4_15.as_ptr(), substring_i: -1, result: -1, function: None },
    among { s_size: 3, s: S_4_16.as_ptr(), substring_i: -1, result: -1, function: None },
    ...
    among { s_size: 6, s: S_4_24.as_ptr(), substring_i: 22, result: -1, function: None },
    among { s_size: 2, s: S_4_25.as_ptr(), substring_i: 19, result: -1, function: None },
    among { s_size: 2, s: S_4_26.as_ptr(), substring_i: 19, result: -1, function: None },
    among { s_size: 4, s: S_4_27.as_ptr(), substring_i: -1, result: -1, function: None },
    ...
    among { s_size: 4, s: S_4_32.as_ptr(), substring_i: 29, result: -1, function: None },
    among { s_size: 6, s: S_4_33.as_ptr(), substring_i: 32, result: -1, function: None },
    among { s_size: 6, s: S_4_34.as_ptr(), substring_i: 32, result: -1, function: None },
    among { s_size: 6, s: S_4_35.as_ptr(), substring_i: 32, result: -1, function: None },
    among { s_size: 2, s: S_4_36.as_ptr(), substring_i: 29, result: -1, function: None },
    among { s_size: 3, s: S_4_37.as_ptr(), substring_i: 29, result: -1, function: None },
    among { s_size: 2, s: S_4_38.as_ptr(), substring_i: 29, result: -1, function: None },
    ...
    among { s_size: 2, s: S_4_42.as_ptr(), substring_i: -1, result: -1, function: None },
    among { s_size: 2, s: S_4_43.as_ptr(), substring_i: -1, result: -1, function: None },
];

static S_5_0: [symbol; 2] = [0xE1, b'n'];
static S_5_1: [symbol; 2] = [0xE9, b'n'];
static S_5_2: [symbol; 6] = [0xE1, b'n', b'k', 0xE9, b'n', b't'];

static A_5: [among; 3] = [
    among { s_size: 2, s: S_5_0.as_ptr(), substring_i: -1, result: 2, function: None },
    among { s_size: 2, s: S_5_1.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 6, s: S_5_2.as_ptr(), substring_i: -1, result: 2, function: None },
];

static S_6_0: [symbol; 4] = [b's', b't', b'u', b'l'];
static S_6_1: [symbol; 5] = [b'a', b's', b't', b'u', b'l'];
static S_6_2: [symbol; 5] = [0xE1, b's', b't', b'u', b'l'];
static S_6_3: [symbol; 4] = [b's', b't', 0xFC, b'l'];
static S_6_4: [symbol; 5] = [b'e', b's', b't', 0xFC, b'l'];
static S_6_5: [symbol; 5] = [0xE9, b's', b't', 0xFC, b'l'];
...
static A_6: [among; 6] = [
    ...
    among { s_size: 5, s: S_6_2.as_ptr(), substring_i: 0, result: 2, function: None },
    among { s_size: 4, s: S_6_3.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 5, s: S_6_4.as_ptr(), substring_i: 3, result: 1, function: None },
    among { s_size: 5, s: S_6_5.as_ptr(), substring_i: 3, result: 3, function: None },
];

static S_7_0: [symbol; 1] = [0xE1];
static S_7_1: [symbol; 1] = [0xE9];
...
static S_8_4: [symbol; 2] = [0xE1, b'k'];
static S_8_5: [symbol; 2] = [0xE9, b'k'];
static S_8_6: [symbol; 2] = [0xF6, b'k'];
...
static A_8: [among; 7] = [
    ...
    among { s_size: 2, s: S_8_4.as_ptr(), substring_i: 0, result: 1, function: None },
    among { s_size: 2, s: S_8_5.as_ptr(), substring_i: 0, result: 2, function: None },
    among { s_size: 2, s: S_8_6.as_ptr(), substring_i: 0, result: 3, function: None },
];

static S_9_0: [symbol; 2] = [0xE9, b'i'];
static S_9_1: [symbol; 3] = [0xE1, 0xE9, b'i'];
static S_9_2: [symbol; 3] = [0xE9, 0xE9, b'i'];
static S_9_3: [symbol; 1] = [0xE9];
static S_9_4: [symbol; 2] = [b'k', 0xE9];
static S_9_5: [symbol; 3] = [b'a', b'k', 0xE9];
static S_9_6: [symbol; 3] = [b'e', b'k', 0xE9];
static S_9_7: [symbol; 3] = [b'o', b'k', 0xE9];
static S_9_8: [symbol; 3] = [0xE1, b'k', 0xE9];
static S_9_9: [symbol; 3] = [0xE9, b'k', 0xE9];
static S_9_10: [symbol; 3] = [0xF6, b'k', 0xE9];
static S_9_11: [symbol; 2] = [0xE9, 0xE9];

static A_9: [among; 12] = [
    among { s_size: 2, s: S_9_0.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 3, s: S_9_1.as_ptr(), substring_i: 0, result: 3, function: None },
    among { s_size: 3, s: S_9_2.as_ptr(), substring_i: 0, result: 2, function: None },
    among { s_size: 1, s: S_9_3.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 2, s: S_9_4.as_ptr(), substring_i: 3, result: 1, function: None },
    among { s_size: 3, s: S_9_5.as_ptr(), substring_i: 4, result: 1, function: None },
    among { s_size: 3, s: S_9_6.as_ptr(), substring_i: 4, result: 1, function: None },
    among { s_size: 3, s: S_9_7.as_ptr(), substring_i: 4, result: 1, function: None },
    among { s_size: 3, s: S_9_8.as_ptr(), substring_i: 4, result: 3, function: None },
    among { s_size: 3, s: S_9_9.as_ptr(), substring_i: 4, result: 2, function: None },
    among { s_size: 3, s: S_9_10.as_ptr(), substring_i: 4, result: 1, function: None },
    among { s_size: 2, s: S_9_11.as_ptr(), substring_i: 3, result: 2, function: None },
];
...
static S_10_6: [symbol; 2] = [0xE1, b'd'];
static S_10_7: [symbol; 2] = [0xE9, b'd'];
static S_10_8: [symbol; 2] = [0xF6, b'd'];
...
static S_10_13: [symbol; 3] = [0xE1, b'n', b'k'];
static S_10_14: [symbol; 3] = [0xE9, b'n', b'k'];
static S_10_15: [symbol; 3] = [0xFC, b'n', b'k'];
static S_10_16: [symbol; 2] = [b'u', b'k'];
static S_10_17: [symbol; 3] = [b'j', b'u', b'k'];
static S_10_18: [symbol; 4] = [0xE1, b'j', b'u', b'k'];
static S_10_19: [symbol; 2] = [0xFC, b'k'];
static S_10_20: [symbol; 3] = [b'j', 0xFC, b'k'];
static S_10_21: [symbol; 4] = [0xE9, b'j', 0xFC, b'k'];
static S_10_22: [symbol; 1] = [b'm'];
static S_10_23: [symbol; 2] = [b'a', b'm'];
static S_10_24: [symbol; 2] = [b'e', b'm'];
static S_10_25: [symbol; 2] = [b'o', b'm'];
static S_10_26: [symbol; 2] = [0xE1, b'm'];
static S_10_27: [symbol; 2] = [0xE9, b'm'];
static S_10_28: [symbol; 1] = [b'o'];
static S_10_29: [symbol; 1] = [0xE1];
static S_10_30: [symbol; 1] = [0xE9];
...
static A_10: [among; 31] = [
    ...
    among { s_size: 2, s: S_10_6.as_ptr(), substring_i: 2, result: 2, function: None },
    among { s_size: 2, s: S_10_7.as_ptr(), substring_i: 2, result: 3, function: None },
    among { s_size: 2, s: S_10_8.as_ptr(), substring_i: 2, result: 1, function: None },
    ...
    among { s_size: 3, s: S_10_13.as_ptr(), substring_i: 11, result: 2, function: None },
    among { s_size: 3, s: S_10_14.as_ptr(), substring_i: 11, result: 3, function: None },
    among { s_size: 3, s: S_10_15.as_ptr(), substring_i: 11, result: 1, function: None },
    ...
    among { s_size: 4, s: S_10_18.as_ptr(), substring_i: 17, result: 2, function: None },
    among { s_size: 2, s: S_10_19.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 3, s: S_10_20.as_ptr(), substring_i: 19, result: 1, function: None },
    among { s_size: 4, s: S_10_21.as_ptr(), substring_i: 20, result: 3, function: None },
    ...
    among { s_size: 2, s: S_10_26.as_ptr(), substring_i: 22, result: 2, function: None },
    among { s_size: 2, s: S_10_27.as_ptr(), substring_i: 22, result: 3, function: None },
    among { s_size: 1, s: S_10_28.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 1, s: S_10_29.as_ptr(), substring_i: -1, result: 2, function: None },
    among { s_size: 1, s: S_10_30.as_ptr(), substring_i: -1, result: 3, function: None },
];
...
static S_11_5: [symbol; 3] = [0xE1, b'i', b'd'];
static S_11_6: [symbol; 3] = [0xE9, b'i', b'd'];
...
static S_11_12: [symbol; 2] = [0xE1, b'i'];
static S_11_13: [symbol; 2] = [0xE9, b'i'];
...
static S_11_17: [symbol; 5] = [0xE9, b'i', b't', b'e', b'k'];
...
static S_11_23: [symbol; 3] = [0xE1, b'i', b'k'];
static S_11_24: [symbol; 3] = [0xE9, b'i', b'k'];
...
static S_11_30: [symbol; 4] = [0xE1, b'i', b'n', b'k'];
static S_11_31: [symbol; 4] = [0xE9, b'i', b'n', b'k'];
static S_11_32: [symbol; 5] = [b'a', b'i', b't', b'o', b'k'];
static S_11_33: [symbol; 6] = [b'j', b'a', b'i', b't', b'o', b'k'];
static S_11_34: [symbol; 5] = [0xE1, b'i', b't', b'o', b'k'];
...
static S_11_40: [symbol; 3] = [0xE1, b'i', b'm'];
static S_11_41: [symbol; 3] = [0xE9, b'i', b'm'];
...
static A_11: [among; 42] = [
    ...
    among { s_size: 3, s: S_11_5.as_ptr(), substring_i: 0, result: 2, function: None },
    among { s_size: 3, s: S_11_6.as_ptr(), substring_i: 0, result: 3, function: None },
    ...
    among { s_size: 2, s: S_11_12.as_ptr(), substring_i: 7, result: 2, function: None },
    among { s_size: 2, s: S_11_13.as_ptr(), substring_i: 7, result: 3, function: None },
    ...
    among { s_size: 5, s: S_11_17.as_ptr(), substring_i: 14, result: 3, function: None },
    ...
    among { s_size: 3, s: S_11_23.as_ptr(), substring_i: 18, result: 2, function: None },
    among { s_size: 3, s: S_11_24.as_ptr(), substring_i: 18, result: 3, function: None },
    ...
    among { s_size: 4, s: S_11_30.as_ptr(), substring_i: 25, result: 2, function: None },
    among { s_size: 4, s: S_11_31.as_ptr(), substring_i: 25, result: 3, function: None },
    ...
    among { s_size: 5, s: S_11_34.as_ptr(), substring_i: -1, result: 2, function: None },
    ...
    among { s_size: 3, s: S_11_40.as_ptr(), substring_i: 35, result: 2, function: None },
    among { s_size: 3, s: S_11_41.as_ptr(), substring_i: 35, result: 3, function: None },
];
    ...
    *(*z).I.offset(0) = (*z).l;
    {
        ...
        'lab0: {
            'lab1: {
                ...
                if in_grouping(z, G_V.as_ptr(), 97, 252, 1) < 0 {
                    break 'lab1;
                }
                'lab2: {
                    let c2 = (*z).c;
                    'lab3: {
                        if (*z).c + 1 >= (*z).l
                            ...
                            || (101187584 >> (*(*z).p.offset(((*z).c + 1) as isize) as c_int & 0x1f)) & 1 == 0
                        {
                            break 'lab3;
                        }
...
unsafe fn r_v_ending(z: *mut SN_env) -> c_int {
    ...
    (*z).ket = (*z).c;
    if (*z).c <= (*z).lb
        || (*(*z).p.offset(((*z).c - 1) as isize) != 225
            && *(*z).p.offset(((*z).c - 1) as isize) != 233)
    {
        return 0;
    }
...
#[no_mangle]
pub unsafe extern "C" fn hungarian_ISO_8859_2_stem(z: *mut SN_env) -> c_int {
    {
        let c1 = (*z).c;
        {
...
#[no_mangle]
pub unsafe extern "C" fn hungarian_ISO_8859_2_create_env() -> *mut SN_env {
    SN_create_env(0, 1)
}

#[no_mangle]
pub unsafe extern "C" fn hungarian_ISO_8859_2_close_env(z: *mut SN_env) {
    SN_close_env(z, 0)
}
...
mod tests {
    ...
    fn idempotent() {
        unsafe {
            for w in [&b"hazaban"[..], &b"emberek"[..], &b"konyvekkel"[..]] {
                let once = stem(w);
    ...
    // A word with the ISO_8859_2 high byte 0xE1 ('a-acute') is handled.
    #[test]
    fn high_byte_no_crash() {
        unsafe {
            let out = stem(b"h\xe1z");
            assert!(!out.is_empty());
        }
    }
}
