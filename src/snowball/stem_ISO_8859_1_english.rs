//! Snowball English (ISO_8859_1) stemmer.
//!
//! 1:1 translation of the generated
//! `src/backend/snowball/libstemmer/stem_ISO_8859_1_english.c` (Snowball 2.2.0),
...
use crate::snowball::utilities::{
    find_among, find_among_b, in_grouping, in_grouping_b, out_grouping, out_grouping_b, slice_del,
    slice_from_s,
};
...
unsafe extern "C" fn r_shortv(z: *mut SN_env) -> c_int {
    'lab0: {
        ...
        'lab1: {
            ...
            if in_grouping_b(z, G_V.as_ptr(), 97, 121, 0) != 0 {
                break 'lab1;
            }
            ...
            (*z).bra = (*z).c;
            {
                ...
                match among_var2 {
                    ...
                    2 => {
                        ...
                        let _ = m3;
                        'lab0: {
                            if in_grouping_b(z, G_AEO.as_ptr(), 97, 111, 0) != 0 {
                                break 'lab0;
                            }
                            if (*z).c > (*z).lb {
                                break 'lab0;
...
unsafe extern "C" fn r_Step_2(z: *mut SN_env) -> c_int {
    ...
    match among_var {
        ...
        15 => {
            if in_grouping_b(z, G_VALID_LI.as_ptr(), 99, 116, 0) != 0 {
                return 0;
            }
            {
                let ret = slice_del(z);
...
#[no_mangle]
pub unsafe extern "C" fn english_ISO_8859_1_stem(z: *mut SN_env) -> c_int {
    'lab0: {
        let c1 = (*z).c;
        'lab1: {
            {
...
#[no_mangle]
pub unsafe extern "C" fn english_ISO_8859_1_create_env() -> *mut SN_env {
    SN_create_env(0, 3)
}

#[no_mangle]
pub unsafe extern "C" fn english_ISO_8859_1_close_env(z: *mut SN_env) {
    SN_close_env(z, 0);
}
...
mod tests {
    ...
    unsafe fn stem(word: &[u8]) -> Vec<u8> {
        let z = english_ISO_8859_1_create_env();
        assert!(!z.is_null());
        let rc = SN_set_current(z, word.len() as c_int, word.as_ptr());
        assert!(rc >= 0);
        let rc = english_ISO_8859_1_stem(z);
