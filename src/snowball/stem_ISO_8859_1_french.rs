//! Snowball French (ISO_8859_1) stemmer.
//!
//! 1:1 translation of the generated
//! `src/backend/snowball/libstemmer/stem_ISO_8859_1_french.c` (Snowball 2.2.0),
...
use crate::snowball::utilities::{
    eq_s, eq_s_b, find_among, find_among_b, in_grouping, in_grouping_b, out_grouping,
    out_grouping_b, slice_del, slice_from_s,
};
...
static S_2_2: [symbol; 3] = [b'I', 0xe8, b'r'];
static S_2_3: [symbol; 3] = [b'i', 0xe8, b'r'];
...
static S_4_33: [symbol; 4] = [b'i', b't', 0xe9, b's'];
...
static S_4_42: [symbol; 3] = [b'i', b't', 0xe9];
...
static S_5_30: [symbol; 2] = [0xee, b't'];
...
static S_6_4: [symbol; 2] = [0xe9, b'e'];
...
static S_6_10: [symbol; 4] = [0xe2, b'm', b'e', b's'];
static S_6_11: [symbol; 5] = [b'a', b's', b's', b'e', b's'];
static S_6_12: [symbol; 5] = [b'a', b'n', b't', b'e', b's'];
static S_6_13: [symbol; 4] = [0xe2, b't', b'e', b's'];
static S_6_14: [symbol; 3] = [0xe9, b'e', b's'];
...
static S_6_22: [symbol; 2] = [0xe9, b's'];
...
static S_6_37: [symbol; 1] = [0xe9];
static S_7_0: [symbol; 1] = [b'e'];
static S_7_1: [symbol; 4] = [b'I', 0xe8, b'r', b'e'];
static S_7_2: [symbol; 4] = [b'i', 0xe8, b'r', b'e'];
...
static S_4: [symbol; 2] = [b'H', b'e'];
static S_5: [symbol; 2] = [b'H', b'i'];
static S_6: [symbol; 1] = [b'Y'];
static S_7: [symbol; 1] = [b'U'];
static S_8: [symbol; 1] = [b'i'];
static S_9: [symbol; 1] = [b'u'];
static S_10: [symbol; 1] = [b'y'];
static S_11: [symbol; 1] = [0xeb];
static S_12: [symbol; 1] = [0xef];
static S_13: [symbol; 2] = [b'i', b'c'];
static S_14: [symbol; 3] = [b'i', b'q', b'U'];
static S_15: [symbol; 3] = [b'l', b'o', b'g'];
static S_16: [symbol; 1] = [b'u'];
static S_17: [symbol; 3] = [b'e', b'n', b't'];
static S_18: [symbol; 2] = [b'a', b't'];
static S_19: [symbol; 3] = [b'e', b'u', b'x'];
static S_20: [symbol; 1] = [b'i'];
static S_21: [symbol; 3] = [b'a', b'b', b'l'];
static S_22: [symbol; 3] = [b'i', b'q', b'U'];
static S_23: [symbol; 2] = [b'a', b't'];
static S_24: [symbol; 2] = [b'i', b'c'];
static S_25: [symbol; 3] = [b'i', b'q', b'U'];
static S_26: [symbol; 3] = [b'e', b'a', b'u'];
static S_27: [symbol; 2] = [b'a', b'l'];
static S_28: [symbol; 3] = [b'e', b'u', b'x'];
static S_29: [symbol; 3] = [b'a', b'n', b't'];
static S_30: [symbol; 3] = [b'e', b'n', b't'];
static S_31: [symbol; 2] = [b'H', b'i'];
static S_32: [symbol; 1] = [b'i'];
static S_33: [symbol; 1] = [b'e'];
static S_34: [symbol; 1] = [b'i'];
static S_35: [symbol; 1] = [b'c'];
...
static A_2: [among; 6] = [
    ...
    among { s_size: 3, s: S_2_2.as_ptr(), substring_i: -1, result: 4, function: None },
...
static A_4: [among; 43] = [
    ...
    among { s_size: 4, s: S_4_33.as_ptr(), substring_i: -1, result: 7, function: None },
    ...
    among { s_size: 3, s: S_4_42.as_ptr(), substring_i: -1, result: 7, function: None },
];
static A_5: [among; 35] = [
    ...
    among { s_size: 4, s: S_5_12.as_ptr(), substring_i: -1, result: 1, function: None },
    ...
    among { s_size: 2, s: S_5_30.as_ptr(), substring_i: -1, result: 1, function: None },
...
static A_6: [among; 38] = [
    ...
    among { s_size: 2, s: S_6_4.as_ptr(), substring_i: -1, result: 2, function: None },
    ...
    among { s_size: 4, s: S_6_10.as_ptr(), substring_i: -1, result: 3, function: None },
    ...
    among { s_size: 4, s: S_6_13.as_ptr(), substring_i: -1, result: 3, function: None },
    among { s_size: 3, s: S_6_14.as_ptr(), substring_i: -1, result: 2, function: None },
    ...
    among { s_size: 2, s: S_6_22.as_ptr(), substring_i: -1, result: 2, function: None },
    ...
    among { s_size: 5, s: S_6_28.as_ptr(), substring_i: -1, result: 2, function: None },
    ...
    among { s_size: 2, s: S_6_31.as_ptr(), substring_i: -1, result: 3, function: None },
    ...
    among { s_size: 1, s: S_6_37.as_ptr(), substring_i: -1, result: 2, function: None },
];
static A_7: [among; 6] = [
    among { s_size: 1, s: S_7_0.as_ptr(), substring_i: -1, result: 3, function: None },
    among { s_size: 4, s: S_7_1.as_ptr(), substring_i: 0, result: 2, function: None },
...
unsafe extern "C" fn r_elisions(z: *mut SN_env) -> c_int {
    (*z).bra = (*z).c;
    {
        let c1 = (*z).c;
        'lab0: {
            'lab1: {
                if in_grouping(z, G_ELISION_CHAR.as_ptr(), 99, 116, 0) != 0 {
                    break 'lab1;
                }
                break 'lab0;
            }
        ...
        'lab0: {
            'inner: loop {
                ...
                'lab1: {
                    'lab2: {
                        {
                            let c3 = (*z).c;
                    'lab3: {
                        if in_grouping(z, G_V.as_ptr(), 97, 251, 0) != 0 {
                            break 'lab3;
                        }
                        (*z).bra = (*z).c;
                        {
                    ...
                    'lab7: {
                        (*z).bra = (*z).c;
                        if (*z).c == (*z).l || *(*z).p.offset((*z).c as isize) != 0xEB {
                            break 'lab7;
                        }
                        (*z).c += 1;
                        (*z).ket = (*z).c;
                    ...
                    'lab8: {
                        (*z).bra = (*z).c;
                        if (*z).c == (*z).l || *(*z).p.offset((*z).c as isize) != 0xEF {
                            break 'lab8;
                        }
                        (*z).c += 1;
                        (*z).ket = (*z).c;
            ...
            // inner loop broke via lab2 (success): outer continue.
            continue 'loop0;
        }
        // lab0:
        (*z).c = c1;
    ...
    *(*z).I.offset(0) = (*z).l;
                ...
                'lab1: {
                    ...
                    'lab3: {
                        if (*z).c + 2 >= (*z).l
                            ...
                            || ((331776 >> (*(*z).p.offset(((*z).c + 2) as isize) as c_int & 0x1f)) & 1) == 0
                        {
                            break 'lab3;
                        }
                    ...
                    {
                        let ret = out_grouping(z, G_V.as_ptr(), 97, 251, 1);
                        if ret < 0 {
                            break 'lab0;
                        }
                        (*z).c += ret;
    ...
    }
    {
        ...
        'lab4: {
            ...
            {
                let ret = in_grouping(z, G_V.as_ptr(), 97, 251, 1);
                if ret < 0 {
                    break 'lab4;
                }
                (*z).c += ret;
...
unsafe extern "C" fn r_standard_suffix(z: *mut SN_env) -> c_int {
    ...
    match among_var {
        ...
        4 => {
            ...
            {
                let ret = slice_from_s(z, 1, S_16.as_ptr());
                if ret < 0 {
                    return ret;
                }
            }
        ...
        12 => {
            ...
            if out_grouping_b(z, G_V.as_ptr(), 97, 251, 0) != 0 {
                return 0;
            }
            {
                let ret = slice_del(z);
        ...
        15 => {
            {
                ...
                if in_grouping_b(z, G_V.as_ptr(), 97, 251, 0) != 0 {
                    return 0;
                }
                {
                    let ret = r_RV(z);
...
unsafe extern "C" fn r_i_verb_suffix(z: *mut SN_env) -> c_int {
    {
        let mlimit1;
        if (*z).c < *(*z).I.offset(2) {
            return 0;
...
unsafe extern "C" fn r_residual_suffix(z: *mut SN_env) -> c_int {
            ...
            (*z).bra = (*z).c;
            {
                let m_test2 = (*z).l - (*z).c;
                {
                    ...
                    'lab1: {
                        ...
                        // lab2:
                        (*z).c = (*z).l - m3;
                        if out_grouping_b(z, G_KEEP_WITH_S.as_ptr(), 97, 232, 0) != 0 {
                            (*z).c = (*z).l - m1;
                            break 'lab0;
                        }
                    }
    ...
    }
    {
        ...
        match among_var {
            ...
            2 => {
                let ret = slice_from_s(z, 1, S_32.as_ptr());
                if ret < 0 {
                    return ret;
                }
            }
...
unsafe extern "C" fn r_un_double(z: *mut SN_env) -> c_int {
    {
        let m_test1 = (*z).l - (*z).c;
        if (*z).c - 2 <= (*z).lb
            || (*(*z).p.offset(((*z).c - 1) as isize) as c_int >> 5) != 3
...
unsafe extern "C" fn r_un_accent(z: *mut SN_env) -> c_int {
    {
        let mut i = 1;
        'loop0: loop {
            'lab0: {
    ...
    (*z).ket = (*z).c;
    {
        ...
        'lab1: {
            'lab2: {
                if (*z).c <= (*z).lb || *(*z).p.offset(((*z).c - 1) as isize) != 0xE9 {
                    break 'lab2;
                }
                (*z).c -= 1;
                break 'lab1;
            ...
            // lab2:
            (*z).c = (*z).l - m1;
            if (*z).c <= (*z).lb || *(*z).p.offset(((*z).c - 1) as isize) != 0xE8 {
                return 0;
            }
            (*z).c -= 1;
        }
...
#[no_mangle]
pub unsafe extern "C" fn french_ISO_8859_1_stem(z: *mut SN_env) -> c_int {
    {
        let c1 = (*z).c;
        {
                            ...
                            'lab6: {
                                (*z).ket = (*z).c;
                                {
                                    ...
                                    'lab7: {
                                        ...
                                        (*z).c = (*z).l - m8;
                                        if (*z).c <= (*z).lb
                                            || *(*z).p.offset(((*z).c - 1) as isize) != 0xE7
                                        {
                                            (*z).c = (*z).l - m7;
                                            break 'lab6;
                                        }
                                        ...
                                        (*z).bra = (*z).c;
                                        {
                                            let ret = slice_from_s(z, 1, S_35.as_ptr());
                                            if ret < 0 {
                                                return ret;
                                            }
                                        }
...
#[no_mangle]
pub unsafe extern "C" fn french_ISO_8859_1_create_env() -> *mut SN_env {
    SN_create_env(0, 3)
}

#[no_mangle]
pub unsafe extern "C" fn french_ISO_8859_1_close_env(z: *mut SN_env) {
    SN_close_env(z, 0);
}
...
mod tests {
    ...
    fn short_root_unchanged() {
        unsafe {
            assert_eq!(stem(b"bal"), b"bal".to_vec());
        }
    }
    ...
    fn suffix_stripped_nonempty() {
        unsafe {
            let r = stem(b"continuellement");
            assert!(!r.is_empty());
            assert!(r.len() <= "continuellement".len());
        }
    }
}
