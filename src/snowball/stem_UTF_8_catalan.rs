//! Catalan Snowball stemmer (UTF-8).
//!
//! 1:1 translation of the generated
//! `src/backend/snowball/libstemmer/stem_UTF_8_catalan.c` (Snowball 2.2.0),
...
use crate::snowball::utilities::{
    find_among, find_among_b, in_grouping_U, out_grouping_U, skip_utf8, slice_del, slice_from_s,
};
...
static S_0_1: [symbol; 2] = [0xC2, 0xB7];
static S_0_2: [symbol; 2] = [0xC3, 0xA0];
static S_0_3: [symbol; 2] = [0xC3, 0xA1];
static S_0_4: [symbol; 2] = [0xC3, 0xA8];
static S_0_5: [symbol; 2] = [0xC3, 0xA9];
static S_0_6: [symbol; 2] = [0xC3, 0xAC];
static S_0_7: [symbol; 2] = [0xC3, 0xAD];
static S_0_8: [symbol; 2] = [0xC3, 0xAF];
static S_0_9: [symbol; 2] = [0xC3, 0xB2];
static S_0_10: [symbol; 2] = [0xC3, 0xB3];
static S_0_11: [symbol; 2] = [0xC3, 0xBA];
static S_0_12: [symbol; 2] = [0xC3, 0xBC];
...
static A_0: [among; 13] = [
    ...
    among { s_size: 2, s: S_0_5.as_ptr(), substring_i: 0, result: 2, function: None },
    among { s_size: 2, s: S_0_6.as_ptr(), substring_i: 0, result: 3, function: None },
    among { s_size: 2, s: S_0_7.as_ptr(), substring_i: 0, result: 3, function: None },
    among { s_size: 2, s: S_0_8.as_ptr(), substring_i: 0, result: 3, function: None },
    among { s_size: 2, s: S_0_9.as_ptr(), substring_i: 0, result: 4, function: None },
    among { s_size: 2, s: S_0_10.as_ptr(), substring_i: 0, result: 4, function: None },
    among { s_size: 2, s: S_0_11.as_ptr(), substring_i: 0, result: 5, function: None },
    among { s_size: 2, s: S_0_12.as_ptr(), substring_i: 0, result: 5, function: None },
];
...
static S_2_1: [symbol; 7] = [b'l', 0xC3, 0xB3, b'g', b'i', b'c', b'a'];
...
static S_2_6: [symbol; 6] = [0xC3, 0xA8, b'n', b'c', b'i', b'a'];
static S_2_7: [symbol; 5] = [0xC3, 0xAD, b'c', b'i', b'a'];
static S_2_8: [symbol; 5] = [b'l', b'o', b'g', b'i', b'a'];
static S_2_9: [symbol; 4] = [b'i', b'n', b'i', b'a'];
static S_2_10: [symbol; 6] = [0xC3, 0xAD, b'i', b'n', b'i', b'a'];
static S_2_11: [symbol; 4] = [b'e', b'r', b'i', b'a'];
static S_2_12: [symbol; 5] = [0xC3, 0xA0, b'r', b'i', b'a'];
static S_2_13: [symbol; 7] = [b'a', b't', 0xC3, 0xB2, b'r', b'i', b'a'];
static S_2_14: [symbol; 4] = [b'a', b'l', b'l', b'a'];
static S_2_15: [symbol; 4] = [b'e', b'l', b'l', b'a'];
static S_2_16: [symbol; 6] = [0xC3, 0xAD, b'v', b'o', b'l', b'a'];
static S_2_17: [symbol; 3] = [b'i', b'm', b'a'];
static S_2_18: [symbol; 7] = [0xC3, 0xAD, b's', b's', b'i', b'm', b'a'];
static S_2_19: [symbol; 9] = [b'q', b'u', 0xC3, 0xAD, b's', b's', b'i', b'm', b'a'];
...
static S_2_41: [symbol; 4] = [b'n', 0xC3, 0xA7, b'a'];
static S_2_42: [symbol; 6] = [b'l', b'o', b'g', 0xC3, 0xAD, b'a'];
static S_2_43: [symbol; 2] = [b'i', b'c'];
static S_2_44: [symbol; 6] = [0xC3, 0xAD, b's', b't', b'i', b'c'];
...
static S_2_60: [symbol; 4] = [0xC3, 0xAD, b'c', b'i'];
...
static S_2_68: [symbol; 5] = [0xC3, 0xAD, b'v', b'o', b'l'];
static S_2_69: [symbol; 4] = [b'i', b's', b'a', b'm'];
static S_2_70: [symbol; 5] = [b'i', b's', b's', b'e', b'm'];
static S_2_71: [symbol; 6] = [0xC3, 0xAC, b's', b's', b'e', b'm'];
static S_2_72: [symbol; 6] = [0xC3, 0xAD, b's', b's', b'e', b'm'];
static S_2_73: [symbol; 6] = [0xC3, 0xAD, b's', b's', b'i', b'm'];
static S_2_74: [symbol; 8] = [b'q', b'u', 0xC3, 0xAD, b's', b's', b'i', b'm'];
static S_2_75: [symbol; 4] = [b'a', b'm', b'e', b'n'];
static S_2_76: [symbol; 6] = [0xC3, 0xAC, b's', b's', b'i', b'n'];
...
static S_2_89: [symbol; 7] = [b'l', 0xC3, 0xB3, b'g', b'i', b'c', b's'];
...
static S_2_95: [symbol; 7] = [0xC3, 0xA8, b'n', b'c', b'i', b'e', b's'];
static S_2_96: [symbol; 6] = [0xC3, 0xAD, b'c', b'i', b'e', b's'];
static S_2_97: [symbol; 6] = [b'l', b'o', b'g', b'i', b'e', b's'];
static S_2_98: [symbol; 5] = [b'i', b'n', b'i', b'e', b's'];
static S_2_99: [symbol; 6] = [0xC3, 0xAD, b'n', b'i', b'e', b's'];
static S_2_100: [symbol; 5] = [b'e', b'r', b'i', b'e', b's'];
static S_2_101: [symbol; 6] = [0xC3, 0xA0, b'r', b'i', b'e', b's'];
static S_2_102: [symbol; 8] = [b'a', b't', 0xC3, 0xB2, b'r', b'i', b'e', b's'];
...
static S_2_107: [symbol; 8] = [0xC3, 0xAD, b's', b's', b'i', b'm', b'e', b's'];
static S_2_108: [symbol; 10] = [b'q', b'u', 0xC3, 0xAD, b's', b's', b'i', b'm', b'e', b's'];
...
static S_2_128: [symbol; 9] = [b'l', 0xC3, 0xB3, b'g', b'i', b'q', b'u', b'e', b's'];
static S_2_129: [symbol; 4] = [b'i', b'v', b'e', b's'];
static S_2_130: [symbol; 6] = [b'a', b't', b'i', b'v', b'e', b's'];
static S_2_131: [symbol; 7] = [b'l', b'o', b'g', 0xC3, 0xAD, b'e', b's'];
static S_2_132: [symbol; 10] = [b'a', b'l', b'l', b'e', b'n', b'g', 0xC3, 0xBC, b'e', b's'];
static S_2_133: [symbol; 4] = [b'i', b'c', b'i', b's'];
static S_2_134: [symbol; 5] = [0xC3, 0xAD, b'c', b'i', b's'];
...
static S_2_142: [symbol; 7] = [0xC3, 0xAD, b's', b's', b'i', b'm', b's'];
static S_2_143: [symbol; 9] = [b'q', b'u', 0xC3, 0xAD, b's', b's', b'i', b'm', b's'];
...
static S_2_161: [symbol; 6] = [0xC3, 0xAF, b't', b'a', b't', b's'];
...
static S_2_172: [symbol; 3] = [0xC3, 0xA8, b's'];
static S_2_173: [symbol; 3] = [0xC3, 0xA9, b's'];
static S_2_174: [symbol; 3] = [0xC3, 0xAD, b's'];
static S_2_175: [symbol; 4] = [b'd', 0xC3, 0xAD, b's'];
static S_2_176: [symbol; 3] = [0xC3, 0xB3, b's'];
...
static S_2_181: [symbol; 5] = [0xC3, 0xAF, b't', b'a', b't'];
...
static S_2_191: [symbol; 6] = [0xC3, 0xAC, b's', b's', b'e', b'u'];
static S_2_192: [symbol; 6] = [0xC3, 0xAD, b's', b's', b'e', b'u'];
static S_2_193: [symbol; 4] = [b't', b'r', b'i', b'u'];
static S_2_194: [symbol; 6] = [0xC3, 0xAD, b's', b's', b'i', b'u'];
static S_2_195: [symbol; 4] = [b'a', b't', b'i', b'u'];
static S_2_196: [symbol; 2] = [0xC3, 0xB3];
static S_2_197: [symbol; 3] = [b'i', 0xC3, 0xB3];
static S_2_198: [symbol; 4] = [b'c', b'i', 0xC3, 0xB3];
static S_2_199: [symbol; 5] = [b'a', b'c', b'i', 0xC3, 0xB3];

static A_2: [among; 200] = [
    among { s_size: 3, s: S_2_0.as_ptr(), substring_i: -1, result: 4, function: None },
    among { s_size: 7, s: S_2_1.as_ptr(), substring_i: 0, result: 3, function: None },
    ...
    among { s_size: 6, s: S_2_6.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 5, s: S_2_7.as_ptr(), substring_i: -1, result: 1, function: None },
    ...
    among { s_size: 6, s: S_2_10.as_ptr(), substring_i: 9, result: 1, function: None },
    among { s_size: 4, s: S_2_11.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 5, s: S_2_12.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 7, s: S_2_13.as_ptr(), substring_i: -1, result: 1, function: None },
    ...
    among { s_size: 6, s: S_2_16.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 3, s: S_2_17.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 7, s: S_2_18.as_ptr(), substring_i: 17, result: 1, function: None },
    among { s_size: 9, s: S_2_19.as_ptr(), substring_i: 18, result: 5, function: None },
    ...
    among { s_size: 4, s: S_2_41.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 6, s: S_2_42.as_ptr(), substring_i: -1, result: 3, function: None },
    among { s_size: 2, s: S_2_43.as_ptr(), substring_i: -1, result: 4, function: None },
    among { s_size: 6, s: S_2_44.as_ptr(), substring_i: 43, result: 1, function: None },
    ...
    among { s_size: 4, s: S_2_60.as_ptr(), substring_i: -1, result: 1, function: None },
    ...
    among { s_size: 5, s: S_2_68.as_ptr(), substring_i: -1, result: 1, function: None },
    ...
    among { s_size: 6, s: S_2_71.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 6, s: S_2_72.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 6, s: S_2_73.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 8, s: S_2_74.as_ptr(), substring_i: 73, result: 5, function: None },
    among { s_size: 4, s: S_2_75.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 6, s: S_2_76.as_ptr(), substring_i: -1, result: 1, function: None },
    ...
    among { s_size: 7, s: S_2_89.as_ptr(), substring_i: 88, result: 3, function: None },
    ...
    among { s_size: 7, s: S_2_95.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 6, s: S_2_96.as_ptr(), substring_i: -1, result: 1, function: None },
    ...
    among { s_size: 6, s: S_2_99.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 5, s: S_2_100.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 6, s: S_2_101.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 8, s: S_2_102.as_ptr(), substring_i: -1, result: 1, function: None },
    ...
    among { s_size: 8, s: S_2_107.as_ptr(), substring_i: 106, result: 1, function: None },
    among { s_size: 10, s: S_2_108.as_ptr(), substring_i: 107, result: 5, function: None },
    ...
    among { s_size: 9, s: S_2_128.as_ptr(), substring_i: 127, result: 3, function: None },
    ...
    among { s_size: 7, s: S_2_131.as_ptr(), substring_i: -1, result: 3, function: None },
    among { s_size: 10, s: S_2_132.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 4, s: S_2_133.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 5, s: S_2_134.as_ptr(), substring_i: -1, result: 1, function: None },
    ...
    among { s_size: 7, s: S_2_142.as_ptr(), substring_i: 141, result: 1, function: None },
    among { s_size: 9, s: S_2_143.as_ptr(), substring_i: 142, result: 5, function: None },
    ...
    among { s_size: 6, s: S_2_161.as_ptr(), substring_i: 156, result: 1, function: None },
    ...
    among { s_size: 3, s: S_2_172.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 3, s: S_2_173.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 3, s: S_2_174.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 4, s: S_2_175.as_ptr(), substring_i: 174, result: 1, function: None },
    among { s_size: 3, s: S_2_176.as_ptr(), substring_i: -1, result: 1, function: None },
    ...
    among { s_size: 5, s: S_2_181.as_ptr(), substring_i: -1, result: 1, function: None },
    ...
    among { s_size: 6, s: S_2_191.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 6, s: S_2_192.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 4, s: S_2_193.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 6, s: S_2_194.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 4, s: S_2_195.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 2, s: S_2_196.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 3, s: S_2_197.as_ptr(), substring_i: 196, result: 1, function: None },
    among { s_size: 4, s: S_2_198.as_ptr(), substring_i: 197, result: 1, function: None },
    among { s_size: 5, s: S_2_199.as_ptr(), substring_i: 198, result: 1, function: None },
];

static S_3_0: [symbol; 3] = [b'a', b'b', b'a'];
static S_3_1: [symbol; 4] = [b'e', b's', b'c', b'a'];
static S_3_2: [symbol; 4] = [b'i', b's', b'c', b'a'];
static S_3_3: [symbol; 5] = [0xC3, 0xAF, b's', b'c', b'a'];
static S_3_4: [symbol; 3] = [b'a', b'd', b'a'];
static S_3_5: [symbol; 3] = [b'i', b'd', b'a'];
static S_3_6: [symbol; 3] = [b'u', b'd', b'a'];
static S_3_7: [symbol; 4] = [0xC3, 0xAF, b'd', b'a'];
...
static S_3_15: [symbol; 4] = [0xC3, 0xAF, b'r', b'a'];
static S_3_16: [symbol; 3] = [b'a', b'v', b'a'];
static S_3_17: [symbol; 3] = [b'i', b'x', b'a'];
static S_3_18: [symbol; 4] = [b'i', b't', b'z', b'a'];
static S_3_19: [symbol; 3] = [0xC3, 0xAD, b'a'];
static S_3_20: [symbol; 5] = [b'a', b'r', 0xC3, 0xAD, b'a'];
static S_3_21: [symbol; 5] = [b'e', b'r', 0xC3, 0xAD, b'a'];
static S_3_22: [symbol; 5] = [b'i', b'r', 0xC3, 0xAD, b'a'];
static S_3_23: [symbol; 3] = [0xC3, 0xAF, b'a'];
static S_3_24: [symbol; 3] = [b'i', b's', b'c'];
static S_3_25: [symbol; 4] = [0xC3, 0xAF, b's', b'c'];
...
static S_3_45: [symbol; 5] = [0xC3, 0xA0, b'r', b'e', b'm'];
static S_3_46: [symbol; 5] = [0xC3, 0xAD, b'r', b'e', b'm'];
static S_3_47: [symbol; 6] = [0xC3, 0xA0, b's', b's', b'e', b'm'];
static S_3_48: [symbol; 6] = [0xC3, 0xA9, b's', b's', b'e', b'm'];
static S_3_49: [symbol; 5] = [b'i', b'g', b'u', b'e', b'm'];
static S_3_50: [symbol; 6] = [0xC3, 0xAF, b'g', b'u', b'e', b'm'];
static S_3_51: [symbol; 4] = [b'a', b'v', b'e', b'm'];
static S_3_52: [symbol; 5] = [0xC3, 0xA0, b'v', b'e', b'm'];
static S_3_53: [symbol; 5] = [0xC3, 0xA1, b'v', b'e', b'm'];
static S_3_54: [symbol; 6] = [b'i', b'r', 0xC3, 0xAC, b'e', b'm'];
static S_3_55: [symbol; 4] = [0xC3, 0xAD, b'e', b'm'];
static S_3_56: [symbol; 6] = [b'a', b'r', 0xC3, 0xAD, b'e', b'm'];
static S_3_57: [symbol; 6] = [b'i', b'r', 0xC3, 0xAD, b'e', b'm'];
...
static S_3_61: [symbol; 6] = [0xC3, 0xA0, b's', b's', b'i', b'm'];
static S_3_62: [symbol; 6] = [0xC3, 0xA8, b's', b's', b'i', b'm'];
static S_3_63: [symbol; 6] = [0xC3, 0xA9, b's', b's', b'i', b'm'];
static S_3_64: [symbol; 6] = [0xC3, 0xAD, b's', b's', b'i', b'm'];
static S_3_65: [symbol; 3] = [0xC3, 0xAF, b'm'];
...
static S_3_72: [symbol; 4] = [0xC3, 0xAD, b'a', b'n'];
static S_3_73: [symbol; 6] = [b'a', b'r', 0xC3, 0xAD, b'a', b'n'];
static S_3_74: [symbol; 6] = [b'e', b'r', 0xC3, 0xAD, b'a', b'n'];
static S_3_75: [symbol; 6] = [b'i', b'r', 0xC3, 0xAD, b'a', b'n'];
...
static S_3_83: [symbol; 5] = [0xC3, 0xA0, b'r', b'e', b'n'];
static S_3_84: [symbol; 5] = [0xC3, 0xAF, b'r', b'e', b'n'];
...
static S_3_90: [symbol; 6] = [0xC3, 0xA9, b's', b's', b'e', b'n'];
static S_3_91: [symbol; 6] = [0xC3, 0xAF, b's', b's', b'e', b'n'];
static S_3_92: [symbol; 6] = [b'e', b's', b'q', b'u', b'e', b'n'];
static S_3_93: [symbol; 6] = [b'i', b's', b'q', b'u', b'e', b'n'];
static S_3_94: [symbol; 7] = [0xC3, 0xAF, b's', b'q', b'u', b'e', b'n'];
static S_3_95: [symbol; 4] = [b'a', b'v', b'e', b'n'];
static S_3_96: [symbol; 4] = [b'i', b'x', b'e', b'n'];
static S_3_97: [symbol; 5] = [b'e', b'i', b'x', b'e', b'n'];
static S_3_98: [symbol; 5] = [0xC3, 0xAF, b'x', b'e', b'n'];
static S_3_99: [symbol; 4] = [0xC3, 0xAF, b'e', b'n'];
...
static S_3_107: [symbol; 6] = [0xC3, 0xAF, b's', b's', b'i', b'n'];
...
static S_3_112: [symbol; 5] = [b'a', b'r', 0xC3, 0xA1, b'n'];
static S_3_113: [symbol; 5] = [b'e', b'r', 0xC3, 0xA1, b'n'];
static S_3_114: [symbol; 5] = [b'i', b'r', 0xC3, 0xA1, b'n'];
static S_3_115: [symbol; 4] = [b'i', 0xC3, 0xAF, b'n'];
...
static S_3_123: [symbol; 4] = [0xC3, 0xAF, b'x', b'o'];
...
static S_3_137: [symbol; 4] = [0xC3, 0xAD, b'a', b's'];
static S_3_138: [symbol; 6] = [b'a', b'r', 0xC3, 0xAD, b'a', b's'];
static S_3_139: [symbol; 6] = [b'e', b'r', 0xC3, 0xAD, b'a', b's'];
static S_3_140: [symbol; 6] = [b'i', b'r', 0xC3, 0xAD, b'a', b's'];
...
static S_3_146: [symbol; 5] = [0xC3, 0xAF, b'd', b'e', b's'];
...
static S_3_154: [symbol; 5] = [0xC3, 0xAF, b'r', b'e', b's'];
...
static S_3_160: [symbol; 6] = [0xC3, 0xAF, b's', b's', b'e', b's'];
static S_3_161: [symbol; 4] = [b'q', b'u', b'e', b's'];
static S_3_162: [symbol; 6] = [b'e', b's', b'q', b'u', b'e', b's'];
static S_3_163: [symbol; 7] = [0xC3, 0xAF, b's', b'q', b'u', b'e', b's'];
...
static S_3_167: [symbol; 5] = [0xC3, 0xAF, b'x', b'e', b's'];
static S_3_168: [symbol; 4] = [0xC3, 0xAF, b'e', b's'];
...
static S_3_172: [symbol; 5] = [0xC3, 0xAD, b'a', b'i', b's'];
static S_3_173: [symbol; 7] = [b'a', b'r', 0xC3, 0xAD, b'a', b'i', b's'];
static S_3_174: [symbol; 7] = [b'e', b'r', 0xC3, 0xAD, b'a', b'i', b's'];
static S_3_175: [symbol; 7] = [b'i', b'r', 0xC3, 0xAD, b'a', b'i', b's'];
...
static S_3_186: [symbol; 6] = [0xC3, 0xAF, b's', b's', b'i', b's'];
...
static S_3_190: [symbol; 4] = [0xC3, 0xA1, b'i', b's'];
static S_3_191: [symbol; 6] = [b'a', b'r', 0xC3, 0xA9, b'i', b's'];
static S_3_192: [symbol; 6] = [b'e', b'r', 0xC3, 0xA9, b'i', b's'];
static S_3_193: [symbol; 6] = [b'i', b'r', 0xC3, 0xA9, b'i', b's'];
...
static S_3_198: [symbol; 7] = [0xC3, 0xA1, b'b', b'a', b'm', b'o', b's'];
static S_3_199: [symbol; 7] = [0xC3, 0xA1, b'r', b'a', b'm', b'o', b's'];
static S_3_200: [symbol; 8] = [b'i', 0xC3, 0xA9, b'r', b'a', b'm', b'o', b's'];
static S_3_201: [symbol; 6] = [0xC3, 0xAD, b'a', b'm', b'o', b's'];
static S_3_202: [symbol; 8] = [b'a', b'r', 0xC3, 0xAD, b'a', b'm', b'o', b's'];
static S_3_203: [symbol; 8] = [b'e', b'r', 0xC3, 0xAD, b'a', b'm', b'o', b's'];
static S_3_204: [symbol; 8] = [b'i', b'r', 0xC3, 0xAD, b'a', b'm', b'o', b's'];
...
static S_3_208: [symbol; 7] = [0xC3, 0xA1, b's', b'e', b'm', b'o', b's'];
static S_3_209: [symbol; 8] = [b'i', 0xC3, 0xA9, b's', b'e', b'm', b'o', b's'];
...
static S_3_218: [symbol; 3] = [0xC3, 0xA0, b's'];
static S_3_219: [symbol; 5] = [b'a', b'r', 0xC3, 0xA0, b's'];
static S_3_220: [symbol; 5] = [b'i', b'r', 0xC3, 0xA0, b's'];
static S_3_221: [symbol; 5] = [b'a', b'r', 0xC3, 0xA1, b's'];
static S_3_222: [symbol; 5] = [b'e', b'r', 0xC3, 0xA1, b's'];
static S_3_223: [symbol; 5] = [b'i', b'r', 0xC3, 0xA1, b's'];
static S_3_224: [symbol; 3] = [0xC3, 0xA9, b's'];
static S_3_225: [symbol; 5] = [b'a', b'r', 0xC3, 0xA9, b's'];
static S_3_226: [symbol; 3] = [0xC3, 0xAD, b's'];
static S_3_227: [symbol; 4] = [b'i', 0xC3, 0xAF, b's'];
...
static S_3_234: [symbol; 3] = [0xC3, 0xAF, b't'];
...
static S_3_241: [symbol; 5] = [0xC3, 0xA0, b'r', b'e', b'u'];
static S_3_242: [symbol; 5] = [0xC3, 0xAD, b'r', b'e', b'u'];
...
static S_3_246: [symbol; 6] = [0xC3, 0xA0, b's', b's', b'e', b'u'];
static S_3_247: [symbol; 6] = [0xC3, 0xA9, b's', b's', b'e', b'u'];
static S_3_248: [symbol; 5] = [b'i', b'g', b'u', b'e', b'u'];
static S_3_249: [symbol; 6] = [0xC3, 0xAF, b'g', b'u', b'e', b'u'];
static S_3_250: [symbol; 5] = [0xC3, 0xA0, b'v', b'e', b'u'];
static S_3_251: [symbol; 5] = [0xC3, 0xA1, b'v', b'e', b'u'];
static S_3_252: [symbol; 5] = [b'i', b't', b'z', b'e', b'u'];
static S_3_253: [symbol; 4] = [0xC3, 0xAC, b'e', b'u'];
static S_3_254: [symbol; 6] = [b'i', b'r', 0xC3, 0xAC, b'e', b'u'];
static S_3_255: [symbol; 4] = [0xC3, 0xAD, b'e', b'u'];
static S_3_256: [symbol; 6] = [b'a', b'r', 0xC3, 0xAD, b'e', b'u'];
static S_3_257: [symbol; 6] = [b'i', b'r', 0xC3, 0xAD, b'e', b'u'];
static S_3_258: [symbol; 5] = [b'a', b's', b's', b'i', b'u'];
static S_3_259: [symbol; 5] = [b'i', b's', b's', b'i', b'u'];
static S_3_260: [symbol; 6] = [0xC3, 0xA0, b's', b's', b'i', b'u'];
static S_3_261: [symbol; 6] = [0xC3, 0xA8, b's', b's', b'i', b'u'];
static S_3_262: [symbol; 6] = [0xC3, 0xA9, b's', b's', b'i', b'u'];
static S_3_263: [symbol; 6] = [0xC3, 0xAD, b's', b's', b'i', b'u'];
static S_3_264: [symbol; 3] = [0xC3, 0xAF, b'u'];
static S_3_265: [symbol; 2] = [b'i', b'x'];
static S_3_266: [symbol; 3] = [b'e', b'i', b'x'];
static S_3_267: [symbol; 3] = [0xC3, 0xAF, b'x'];
static S_3_268: [symbol; 3] = [b'i', b't', b'z'];
static S_3_269: [symbol; 3] = [b'i', 0xC3, 0xA0];
static S_3_270: [symbol; 4] = [b'a', b'r', 0xC3, 0xA0];
static S_3_271: [symbol; 4] = [b'i', b'r', 0xC3, 0xA0];
static S_3_272: [symbol; 5] = [b'i', b't', b'z', 0xC3, 0xA0];
static S_3_273: [symbol; 4] = [b'a', b'r', 0xC3, 0xA1];
static S_3_274: [symbol; 4] = [b'e', b'r', 0xC3, 0xA1];
static S_3_275: [symbol; 4] = [b'i', b'r', 0xC3, 0xA1];
static S_3_276: [symbol; 4] = [b'i', b'r', 0xC3, 0xA8];
static S_3_277: [symbol; 4] = [b'a', b'r', 0xC3, 0xA9];
static S_3_278: [symbol; 4] = [b'e', b'r', 0xC3, 0xA9];
static S_3_279: [symbol; 4] = [b'i', b'r', 0xC3, 0xA9];
static S_3_280: [symbol; 2] = [0xC3, 0xAD];
static S_3_281: [symbol; 3] = [b'i', 0xC3, 0xAF];
static S_3_282: [symbol; 3] = [b'i', 0xC3, 0xB3];
...
static A_3: [among; 283] = [
    ...
    among { s_size: 5, s: S_3_3.as_ptr(), substring_i: -1, result: 1, function: None },
    ...
    among { s_size: 3, s: S_3_19.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 5, s: S_3_20.as_ptr(), substring_i: 19, result: 1, function: None },
    among { s_size: 5, s: S_3_21.as_ptr(), substring_i: 19, result: 1, function: None },
    among { s_size: 5, s: S_3_22.as_ptr(), substring_i: 19, result: 1, function: None },
    ...
    among { s_size: 4, s: S_3_25.as_ptr(), substring_i: -1, result: 1, function: None },
    ...
    among { s_size: 5, s: S_3_45.as_ptr(), substring_i: 42, result: 1, function: None },
    among { s_size: 5, s: S_3_46.as_ptr(), substring_i: 42, result: 1, function: None },
    among { s_size: 6, s: S_3_47.as_ptr(), substring_i: 42, result: 1, function: None },
    among { s_size: 6, s: S_3_48.as_ptr(), substring_i: 42, result: 1, function: None },
    among { s_size: 5, s: S_3_49.as_ptr(), substring_i: 42, result: 1, function: None },
    among { s_size: 6, s: S_3_50.as_ptr(), substring_i: 42, result: 1, function: None },
    among { s_size: 4, s: S_3_51.as_ptr(), substring_i: 42, result: 1, function: None },
    among { s_size: 5, s: S_3_52.as_ptr(), substring_i: 42, result: 1, function: None },
    among { s_size: 5, s: S_3_53.as_ptr(), substring_i: 42, result: 1, function: None },
    among { s_size: 6, s: S_3_54.as_ptr(), substring_i: 42, result: 1, function: None },
    among { s_size: 4, s: S_3_55.as_ptr(), substring_i: 42, result: 1, function: None },
    among { s_size: 6, s: S_3_56.as_ptr(), substring_i: 55, result: 1, function: None },
    among { s_size: 6, s: S_3_57.as_ptr(), substring_i: 55, result: 1, function: None },
    ...
    among { s_size: 6, s: S_3_61.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 6, s: S_3_62.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 6, s: S_3_63.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 6, s: S_3_64.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 3, s: S_3_65.as_ptr(), substring_i: -1, result: 1, function: None },
    ...
    among { s_size: 4, s: S_3_72.as_ptr(), substring_i: 66, result: 1, function: None },
    among { s_size: 6, s: S_3_73.as_ptr(), substring_i: 72, result: 1, function: None },
    among { s_size: 6, s: S_3_74.as_ptr(), substring_i: 72, result: 1, function: None },
    among { s_size: 6, s: S_3_75.as_ptr(), substring_i: 72, result: 1, function: None },
    ...
    among { s_size: 5, s: S_3_83.as_ptr(), substring_i: 76, result: 1, function: None },
    among { s_size: 5, s: S_3_84.as_ptr(), substring_i: 76, result: 1, function: None },
    ...
    among { s_size: 6, s: S_3_90.as_ptr(), substring_i: 76, result: 1, function: None },
    among { s_size: 6, s: S_3_91.as_ptr(), substring_i: 76, result: 1, function: None },
    ...
    among { s_size: 7, s: S_3_94.as_ptr(), substring_i: 76, result: 1, function: None },
    ...
    among { s_size: 5, s: S_3_98.as_ptr(), substring_i: 76, result: 1, function: None },
    among { s_size: 4, s: S_3_99.as_ptr(), substring_i: 76, result: 1, function: None },
    ...
    among { s_size: 6, s: S_3_107.as_ptr(), substring_i: 102, result: 1, function: None },
    ...
    among { s_size: 5, s: S_3_112.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 5, s: S_3_113.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 5, s: S_3_114.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 4, s: S_3_115.as_ptr(), substring_i: -1, result: 1, function: None },
    ...
    among { s_size: 4, s: S_3_123.as_ptr(), substring_i: -1, result: 1, function: None },
    ...
    among { s_size: 4, s: S_3_137.as_ptr(), substring_i: 131, result: 1, function: None },
    among { s_size: 6, s: S_3_138.as_ptr(), substring_i: 137, result: 1, function: None },
    among { s_size: 6, s: S_3_139.as_ptr(), substring_i: 137, result: 1, function: None },
    among { s_size: 6, s: S_3_140.as_ptr(), substring_i: 137, result: 1, function: None },
    ...
    among { s_size: 5, s: S_3_146.as_ptr(), substring_i: 142, result: 1, function: None },
    ...
    among { s_size: 5, s: S_3_154.as_ptr(), substring_i: 142, result: 1, function: None },
    ...
    among { s_size: 6, s: S_3_160.as_ptr(), substring_i: 142, result: 1, function: None },
    ...
    among { s_size: 7, s: S_3_163.as_ptr(), substring_i: 161, result: 1, function: None },
    ...
    among { s_size: 5, s: S_3_167.as_ptr(), substring_i: 142, result: 1, function: None },
    among { s_size: 4, s: S_3_168.as_ptr(), substring_i: 142, result: 1, function: None },
    ...
    among { s_size: 5, s: S_3_172.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 7, s: S_3_173.as_ptr(), substring_i: 172, result: 1, function: None },
    among { s_size: 7, s: S_3_174.as_ptr(), substring_i: 172, result: 1, function: None },
    among { s_size: 7, s: S_3_175.as_ptr(), substring_i: 172, result: 1, function: None },
    ...
    among { s_size: 6, s: S_3_186.as_ptr(), substring_i: 181, result: 1, function: None },
    ...
    among { s_size: 4, s: S_3_190.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 6, s: S_3_191.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 6, s: S_3_192.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 6, s: S_3_193.as_ptr(), substring_i: -1, result: 1, function: None },
    ...
    among { s_size: 7, s: S_3_198.as_ptr(), substring_i: 197, result: 1, function: None },
    among { s_size: 7, s: S_3_199.as_ptr(), substring_i: 197, result: 1, function: None },
    among { s_size: 8, s: S_3_200.as_ptr(), substring_i: 197, result: 1, function: None },
    among { s_size: 6, s: S_3_201.as_ptr(), substring_i: 197, result: 1, function: None },
    among { s_size: 8, s: S_3_202.as_ptr(), substring_i: 201, result: 1, function: None },
    among { s_size: 8, s: S_3_203.as_ptr(), substring_i: 201, result: 1, function: None },
    among { s_size: 8, s: S_3_204.as_ptr(), substring_i: 201, result: 1, function: None },
    ...
    among { s_size: 7, s: S_3_208.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 8, s: S_3_209.as_ptr(), substring_i: -1, result: 1, function: None },
    ...
    among { s_size: 3, s: S_3_218.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 5, s: S_3_219.as_ptr(), substring_i: 218, result: 1, function: None },
    among { s_size: 5, s: S_3_220.as_ptr(), substring_i: 218, result: 1, function: None },
    among { s_size: 5, s: S_3_221.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 5, s: S_3_222.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 5, s: S_3_223.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 3, s: S_3_224.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 5, s: S_3_225.as_ptr(), substring_i: 224, result: 1, function: None },
    among { s_size: 3, s: S_3_226.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 4, s: S_3_227.as_ptr(), substring_i: -1, result: 1, function: None },
    ...
    among { s_size: 3, s: S_3_234.as_ptr(), substring_i: -1, result: 1, function: None },
    ...
    among { s_size: 5, s: S_3_241.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 5, s: S_3_242.as_ptr(), substring_i: -1, result: 1, function: None },
    ...
    among { s_size: 6, s: S_3_246.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 6, s: S_3_247.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 5, s: S_3_248.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 6, s: S_3_249.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 5, s: S_3_250.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 5, s: S_3_251.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 5, s: S_3_252.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 4, s: S_3_253.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 6, s: S_3_254.as_ptr(), substring_i: 253, result: 1, function: None },
    among { s_size: 4, s: S_3_255.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 6, s: S_3_256.as_ptr(), substring_i: 255, result: 1, function: None },
    among { s_size: 6, s: S_3_257.as_ptr(), substring_i: 255, result: 1, function: None },
    ...
    among { s_size: 6, s: S_3_260.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 6, s: S_3_261.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 6, s: S_3_262.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 6, s: S_3_263.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 3, s: S_3_264.as_ptr(), substring_i: -1, result: 1, function: None },
    ...
    among { s_size: 3, s: S_3_267.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 3, s: S_3_268.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 3, s: S_3_269.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 4, s: S_3_270.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 4, s: S_3_271.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 5, s: S_3_272.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 4, s: S_3_273.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 4, s: S_3_274.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 4, s: S_3_275.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 4, s: S_3_276.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 4, s: S_3_277.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 4, s: S_3_278.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 4, s: S_3_279.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 2, s: S_3_280.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 3, s: S_3_281.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 3, s: S_3_282.as_ptr(), substring_i: -1, result: 1, function: None },
];

static S_4_0: [symbol; 1] = [b'a'];
static S_4_1: [symbol; 1] = [b'e'];
static S_4_2: [symbol; 1] = [b'i'];
static S_4_3: [symbol; 3] = [0xC3, 0xAF, b'n'];
...
static S_4_9: [symbol; 3] = [0xC3, 0xAF, b's'];
...
static S_4_15: [symbol; 2] = [0xC3, 0xA0];
static S_4_16: [symbol; 2] = [0xC3, 0xA1];
static S_4_17: [symbol; 2] = [0xC3, 0xA9];
static S_4_18: [symbol; 2] = [0xC3, 0xAC];
static S_4_19: [symbol; 2] = [0xC3, 0xAD];
static S_4_20: [symbol; 2] = [0xC3, 0xAF];
static S_4_21: [symbol; 2] = [0xC3, 0xB3];
...
static A_4: [among; 22] = [
    ...
    among { s_size: 3, s: S_4_3.as_ptr(), substring_i: -1, result: 1, function: None },
    ...
    among { s_size: 3, s: S_4_9.as_ptr(), substring_i: 6, result: 1, function: None },
    ...
    among { s_size: 2, s: S_4_15.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 2, s: S_4_16.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 2, s: S_4_17.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 2, s: S_4_18.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 2, s: S_4_19.as_ptr(), substring_i: -1, result: 1, function: None },
    among { s_size: 2, s: S_4_20.as_ptr(), substring_i: -1, result: 1, function: None },
...
unsafe fn r_cleaning(z: *mut SN_env) -> c_int {
    let mut among_var;
    'cat0: loop {
        let c1 = (*z).c;
        'lab0: {
            ...
            if (*z).c + 1 >= (*z).l
                ...
                || (344765187 >> (*(*z).p.offset(((*z).c + 1) as isize) as c_int & 0x1f)) & 1 == 0
            {
                among_var = 7;
            } else {
...
#[no_mangle]
pub unsafe extern "C" fn catalan_UTF_8_stem(z: *mut SN_env) -> c_int {
    {
...
#[no_mangle]
pub unsafe extern "C" fn catalan_UTF_8_create_env() -> *mut SN_env {
    SN_create_env(0, 2)
}

#[no_mangle]
pub unsafe extern "C" fn catalan_UTF_8_close_env(z: *mut SN_env) {
    SN_close_env(z, 0)
}
...
mod tests {
    ...
    fn short_root_unchanged() {
        unsafe {
            assert_eq!(stem(b"pa"), b"pa".to_vec());
        }
    }
    ...
    fn suffix_stripped_nonempty() {
        unsafe {
            let r = stem(b"perfecta");
            assert!(!r.is_empty());
            assert!(r.len() <= "perfecta".len());
        }
    }
}
