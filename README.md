...
A PostgreSQL implementation in Rust, built for production.

## Motivation

What if PostgreSQL were written in Rust? Rust's ownership model, memory safety guarantees, and first-class concurrency support make it an ideal foundation for a database system. PepperDB reimplements PostgreSQL's core components in Rust with the goal of becoming a production-ready database.
...
- **Production-ready** — correctness, durability, and performance suitable for real workloads
