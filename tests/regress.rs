...
regress_test!(basics, select, orderby, boolean, int2, int8, float, text, null, update, delete, drop_table, int4, case_expr, expressions, strings, limit, distinct, alias, groupby, join, subquery);
